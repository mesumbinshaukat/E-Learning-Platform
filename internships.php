                ...
                <div class="row align-items-center justify-content-lg-between justify-content-sm-center">
                    <div class="col-md-6 col-lg-6 mb-4 mb-md-4 mb-lg-0">
                        <div class="hero-slider-content">
                            ...
                            <p class="lead">Consulted or acuteness dejection an smallness if. Outward general passage
                                another as it.</p>
                            <a href="./internshipslist.php" class="btn btn-secondary mt-3">Available
                                Internships</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="section-heading text-center mb-5">
                            <h2>Categories</h2>
                            <p class="lead">Plenty season beyond by hardly giving of
                            <p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <p class="mb-0">Affronting everything discretion men now own did. Still round match we to.
                                Frankness pronounce daughters remainder extensive has but.</p>
                        </div>
                        <!-- End of Icon box -->
                    </div>
                    <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <p class="mb-0">By outward neither he so covered amiable greater. Juvenile proposal betrayed
                                he an informed weddings followed.</p>
                        </div>
                        <!-- End of Icon box -->
                    </div>
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <p class="mb-0">She education get middleton day agreement performed preserved unwilling. Do
                                however as pleased offence outward beloved by present.</p>
                        </div>
                        <!-- End of Icon box -->
                    </div>
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 mb-md-0">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <p class="mb-0">Savings her pleased are several started females met. Short her not among
                                being any. Thing of judge fruit charm views do. Miles mr an forty along as he.</p>
                        </div>
                        <!-- End of Icon box -->
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 mb-md-0">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <p class="mb-0">Farther be chapter at visited married in it pressed. By distrusts procuring
                                be oh frankness existence believing instantly if.</p>
                        </div>
                        <!-- End of Icon box -->
                    </div>
