        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-theme-white fixed-top headroom">
            <div class="container position-relative">
                <a class="navbar-brand mr-lg-3" href="index.php">
                    <img class="navbar-brand-dark" src="assets/img/web/logoblack.png" alt="menuimage">
                    <img class="navbar-brand-light" src="assets/img/web/logowhite.png" alt="menuimage">
                </a>
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="#">
                                    <img src="assets/img/web/logoblack.png" alt="menuimage">
                                </a>
                            </div>
                    ...
                    <ul class="navbar-nav navbar-nav-hover ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="sub-menu dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="internships.php">Internships</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                                    <a href="#" class="dropdown-toggle dropdown-item d-flex justify-content-between align-items-center" aria-haspopup="true" aria-expanded="false">Login <i class="fas fa-angle-right nav-link-arrow"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="superadmin.php">Super admin</a></li>
                                        <li><a class="dropdown-item" href="employee.php">Employee</a></li>
                                        <li><a class="dropdown-item" href="students.php">Student</a></li>
                                        <li><a class="dropdown-item" href="college.php">College</a></li>
                                        <li><a class="dropdown-item" href="collegementor.php">College-mentor</a></li>
                                        <li><a class="dropdown-item" href="trainer.php">Trainer</a></li>
                                        <li><a class="dropdown-item" href="company.php">Company</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="#" class="dropdown-toggle dropdown-item d-flex justify-content-between align-items-center" aria-haspopup="true" aria-expanded="false">Register<i class="fas fa-angle-right nav-link-arrow"></i></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="companyregister.php">Company</a></li>
                    ...
                    <div class="col-md-5 col-lg-15">
                        <div class="card login-signup-card shadow-lg mb-0">
                                ...
                                <form class="login-signup-form" action="" method="POST">
                                    ...
                                    <div class="my-4">
                                        <div class="form-check square-check">
                                            <input class="form-check-input" name="checkbox" type="checkbox" value="terms" id="check-terms" required>
                            ...
                            <div class="card-footer bg-soft text-center border-top px-md-5"><small>Already
                                    registered?</small>
                                <a href="students.php" class="small"> Login</a>
                            </div>
                        </div>
                    </div>
                </div>
