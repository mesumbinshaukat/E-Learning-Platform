							...
							<div class="card-body d-md-flex">
								...
								<div class="my-md-auto mt-4 prof-details">
									...
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
											...
											class="font-weight-semibold me-2">Phone:</span><span>1234569856</span>
									</p>
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
												class="fa fa-envelope me-2"></i></span><span
											class="font-weight-semibold me-2">Email:</span><span>demo2024@gmail.com</span>
									</p>
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
												class="far fa-flag me-2"></i></span><span
											class="font-weight-semibold me-2">Address:</span><span> Hyderabad</span>
									</p>
...
<button class="btn btn-primary mb-3 shadow"><a href="updatestudentprofile.php@id=769.html"><span style="color:#ffffff;">CV Download</span></a></button> 
								...
								<div class="main-content-body tab-pane  active" id="about">
									<div class="card">
										<div class="card-body border-0">
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Student Name" name="student_name" value="Demo2024" >
											...
											<option value="ratherNotSay" >Rather Not Say</option>
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="date" class="form-control" id="dateMask"
																placeholder="DD/MM/YYYY" name="date_of_birth" value="2000-05-10">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="Number" class="form-control"
																placeholder="10 Digit Number" name="phone_number" value="1234569856" >
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																placeholder="10 Digit Number" name="alternative_phone_number" value="8523654895" >
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="District" name="district" value="Hyderabad" >
														</div>
													</div>
												</div>
																								<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="State" name="state" id="exampleInputPerEmail" value="ANDHRA PRADESH">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																placeholder="Pincode" name="pincode" id="exampleInputPerEmail" value="500016">
														</div>
													</div>
												</div>
												<div class="form-group ">
											...
											<option value="6thsem"  selected="selected">6th sem</option>
											...
											<option value="notrequired" > Not required </option>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Branch/Stream" name="stream" id="exampleInputPerEmail"  value="BSC" >
														</div>
													</div>
												</div>
											...
											<option value="individual"  selected="selected">individual</option>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Institutions" name="institution_name" value="GNR Degree College"
																>
														</div>
													</div>
												</div>
												...
												<button type="submit" name="update" class="btn btn-success mt-3 mb-0"  style="text-align:right">Update</button> &nbsp &nbsp
        ...
        <!-- Internal Select2 js-->
        <script src="https://triaright.com/Student/assets/plugins/select2/js/select2.min.js"></script>
        <script src="https://triaright.com/Student/assets/js/select2.js"></script>


        <script src="https://triaright.com/Student/assets/js/gallery.js"></script>
