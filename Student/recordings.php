...
<head>
        ...
        <!-- FAVICON -->
<link rel="icon" href="https://triaright.com/Student/assets/img/icon.png" type="image/x-icon"/>

		<!-- ICONS CSS -->
		<link href="https://triaright.com/Student/assets/plugins/icons/icons.css" rel="stylesheet">

		<!-- BOOTSTRAP CSS -->
		<link href="https://triaright.com/Student/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

		<!-- RIGHT-SIDEMENU CSS -->
		<link href="https://triaright.com/Student/assets/plugins/sidebar/sidebar.css" rel="stylesheet">

		<!-- P-SCROLL BAR CSS -->
		<link href="https://triaright.com/Student/assets/plugins/perfect-scrollbar/p-scrollbar.css" rel="stylesheet" />

        
		<!-- Data table css -->
		<link href="https://triaright.com/Student/assets/plugins/datatable/css/dataTables.bootstrap5.css" rel="stylesheet" />
		<link href="https://triaright.com/Student/assets/plugins/datatable/css/buttons.bootstrap5.min.css"  rel="stylesheet">
		<link href="https://triaright.com/Student/assets/plugins/datatable/responsive.bootstrap5.css" rel="stylesheet" />

		<!-- INTERNAL Select2 css -->
		<link href="https://triaright.com/Student/assets/plugins/select2/css/select2.min.css" rel="stylesheet" />

            
		<!-- STYLES CSS -->
		<link href="https://triaright.com/Student/assets/css/style.css" rel="stylesheet">
		<link href="https://triaright.com/Student/assets/css/style-dark.css" rel="stylesheet">
		<link href="https://triaright.com/Student/assets/css/style-transparent.css" rel="stylesheet">


		<!-- SKIN-MODES CSS -->
		<link href="https://triaright.com/Student/assets/css/skin-modes.css" rel="stylesheet" />

		<!-- ANIMATION CSS -->
		<link href="https://triaright.com/Student/assets/css/animate.css" rel="stylesheet">

	    <!-- SWITCHER CSS -->
		<link href="https://triaright.com/Student/assets/switcher/css/switcher.css" rel="stylesheet"/>
		<link href="https://triaright.com/Student/assets/switcher/demo.css" rel="stylesheet"/>
					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="recordings.php@batch_id=5.html" class="header-logo">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="recordings.php@batch_id=5.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/images/students/profile/" class=""></a>
 ...
 <div class="sticky">
							...
							<ul class="side-menu">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/courseregistration.php">Registrations</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/coursetransactions.php">Transactactions</a></li>	
										<li><a class="slide-item" href="https://triaright.com/Student/coursepayments.php">Payments</a></li>	
									</ul>
								</li>
																<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/internshipregister.php">List</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/intershipregistration.php">Registrations</a></li>
									</ul>
								</li>
																								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/placementsregister.php">List</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/placementsregistration.php">Registrations</a></li>
									</ul>
								</li>
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/mycourses.php">My Courses</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/myinternships.php">My Internships</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/myplacements.php">My Placements</a></li>
									</ul>
								</li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/allmessages.php">All Details</a></li>
									</ul>
								</li>
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/Student/documentation.php">Documentations</a></li>
										<li><a class="slide-item" href="https://triaright.com/Student/certifications.php">Certifications</a></li>
									</ul>
								</li>
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">Recordings</span>
						</div>
			...
			<div class="main-footer">
				<div class="container-fluid pd-t-0-f ht-100p">
					 Copyright © 2023 <a href="https://triaright.com/Student/www.triaright.com" class="text-primary">triaright</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="http://www.mycompany.co.in"> my company</a> . All rights reserved
				</div>
			</div>
			<!-- Footer closed -->
        ...
        <!-- BACK-TO-TOP -->
		<a href="recordings.php@batch_id=5.html#top" id="back-to-top"><i class="las la-arrow-up"></i></a>

		<!-- JQUERY JS -->
		<script src="https://triaright.com/Student/assets/plugins/jquery/jquery.min.js"></script>

		<!-- BOOTSTRAP JS -->
		<script src="https://triaright.com/Student/assets/plugins/bootstrap/js/popper.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

		<!-- IONICONS JS -->
		<script src="https://triaright.com/Student/assets/plugins/ionicons/ionicons.js"></script>

		<!-- MOMENT JS -->
		<script src="https://triaright.com/Student/assets/plugins/moment/moment.js"></script>

		<!-- P-SCROLL JS -->
		<script src="https://triaright.com/Student/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/perfect-scrollbar/p-scroll.js"></script>

		<!-- SIDEBAR JS -->
		<script src="https://triaright.com/Student/assets/plugins/side-menu/sidemenu.js"></script>

		<!-- STICKY JS -->
		<script src="https://triaright.com/Student/assets/js/sticky.js"></script>

		<!-- Chart-circle js -->
		<script src="https://triaright.com/Student/assets/plugins/circle-progress/circle-progress.min.js"></script>

		<!-- RIGHT-SIDEBAR JS -->
		<script src="https://triaright.com/Student/assets/plugins/sidebar/sidebar.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/sidebar/sidebar-custom.js"></script>

        
		<!-- Internal Data tables -->
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/dataTables.buttons.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/buttons.bootstrap5.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/jszip.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/pdfmake/pdfmake.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/pdfmake/vfs_fonts.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/buttons.html5.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/buttons.print.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/js/buttons.colVis.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/dataTables.responsive.min.js"></script>
		<script src="https://triaright.com/Student/assets/plugins/datatable/responsive.bootstrap5.min.js"></script>
		<script src="https://triaright.com/Student/assets/js/table-data.js"></script>

		<!-- INTERNAL Select2 js -->
		<script src="https://triaright.com/Student/assets/plugins/select2/js/select2.full.min.js"></script>

    
		<!-- EVA-ICONS JS -->
		<script src="https://triaright.com/Student/assets/plugins/eva-icons/eva-icons.min.js"></script>

		<!-- THEME-COLOR JS -->
		<script src="https://triaright.com/Student/assets/js/themecolor.js"></script>

		<!-- CUSTOM JS -->
		<script src="https://triaright.com/Student/assets/js/custom.js"></script>

		<!-- exported JS -->
		<script src="https://triaright.com/Student/assets/js/exported.js"></script>

		<!-- SWITCHER JS -->
		<script src="https://triaright.com/Student/assets/switcher/js/switcher.js"></script>
