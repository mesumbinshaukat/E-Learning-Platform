									...
									<div class="row">
										...
										<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
											<div class="text-justified align-items-center">
												...
												<p class="text-dark tx-15 mb-2 lh-3">Thankyou for choosing us, We are delighted that you have joined us and we look forward to providing you with a wealth of resources and information that will help you succeed in your academic journey.</p>
...
<div class="col-sm-12 col-lg-6">
						<div class="card">
								...
								<!--	<div class="card-title pb-0  mb-2"> </div> -->
									...
									<div class="latest-timeline mt-4">
										<ul class="timeline mb-0">
											...
											<li class="mt-0 activity border br-5 p-2 mb-3">
												<div><span class="tx-11 text-muted float-end">01 Jan, 2022</span></div>
												<a  href="javascript:void(0);" class="tx-12 text-dark">
												<p class="mb-1 font-weight-semibold text-dark tx-13">Neetato</p>
												</a>
												<p class="text-muted mt-0 mb-0 tx-12">Lorem ipsum dolor tempor incididunt . </p>
											</li>
										</ul>
