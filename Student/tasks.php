					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="tasks.php@batch_id=5.html" class="header-logo">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="tasks.php@batch_id=5.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/images/students/profile/" class=""></a>
...
<div class="breadcrumb-header justify-content-between">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to update your work?</p>
                                </div>
        ...
        <!-- BACK-TO-TOP -->
		<a href="tasks.php@batch_id=5.html#top" id="back-to-top"><i class="las la-arrow-up"></i></a>
