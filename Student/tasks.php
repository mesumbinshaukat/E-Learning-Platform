...
$query = "SELECT *
FROM ((batches_tasks
INNER JOIN batch ON batches_tasks.batch_id = batch.id)
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="text-justified align-items-center">
                                                <h4 class="product-title mb-1"><b
                                                        style="color: #ff6700;"><?php echo $data['task_name']; ?></b>
                                                </h4>
                                                ...
                                                <p class="card-text tx-15"><span style="color: #13131a;">Type 
                                                    ...
                                                    <?php echo $data['allocated_students_type'];?>
                                                </p>
                                                <p class="card-text tx-15"><span style="color: #13131a;"> Description
                                                        &nbsp
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <?php echo $data['task_description'];?></p>
                                                <p class="card-text tx-15"><span style="color: #13131a;"> Due Date
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <?php echo $data['task_end_date'];?></p>
