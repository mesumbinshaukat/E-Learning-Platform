...
$query = "SELECT *
FROM ((batches_documentation
INNER JOIN batch ON batches_documentation.batch_id = batch.id)
        ...
        <div>
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    echo "<h2>No Documentations found!</h2>";
                } else {
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="text-justified align-items-center">
                                                <h4 class="product-title mb-1"><b
                                                        style="color: #ff6700;"><?php echo $data['date_of_documentation']; ?></b>
                                                </h4>
                                                ...
                                                <p class="card-text tx-15"><span style="color: #13131a;">Description 
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <?php echo $data['description'];?>
                                                </p>
                                                <p class="card-text tx-15"><span style="color: #13131a;"> Additional Information
                                                        &nbsp
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <?php echo $data['additional_information'];?></p>
