				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
							<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Course Registrations</span>
						</div>
									...
									<div class="row">
										...
										<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
											<div class="text-justified align-items-center">
												...
												<p class="card-text tx-15"><span style="color: #13131a;"><b> Course Fee :</b></span>&nbsp5400</p>
												...
												<p class="card-text tx-15"><span style="color: #13131a;"><b>Status :</b></span>&nbsp Pending payments</p>
												<div class="row">
													<button class="btn btn-danger mb-3 shadow"><a href="../superadmin/connection_files/manage/student_login_removecourse.php?crid=28&sid="><span style="color:#ffffff;">Remove</span></a></button> &nbsp &nbsp
													<button class="btn btn-info mb-3 shadow"><a href="coursedetails1.php?details=28"><span style="color:#ffffff;">View More</span></a></button> &nbsp &nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=28"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp
