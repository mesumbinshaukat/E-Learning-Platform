					...
					<aside class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="../../"><i class="fe fe-log-out" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp
							...
							<div class="card custom-card">
								<div class="card-body d-md-flex">
									...
									<div class="my-md-auto mt-4 prof-details">
										...
										<p class="text-muted ms-md-4 ms-0 mb-3"><span><i class="fa fa-phone me-2"></i></span><span class="font-weight-semibold me-2">Phone:</span></span>
										</p>
										...
										&nbsp
										<button class="btn btn-primary mb-3 shadow"><a href="../images/students/cv/"><span style="color:#ffffff;">CV
											...
											<form class="form-horizontal">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control" placeholder="Student Name" name="student_name" value="">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control" placeholder="Gender" name="gender" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="date" class="form-control" id="dateMask" placeholder="DD/MM/YYYY" name="date_of_birth" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="Number" class="form-control" placeholder="10 Digit Number" name="phone_number" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="number" class="form-control" placeholder="10 Digit Number" name="alternative_phone_number" value="">
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="mail" class="form-control" placeholder="Email" name="mail_id" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly readonly type="text" class="form-control" id="exampleInputName" name="address" value="">
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="District" name="district" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="State" name="state" id="exampleInputPerEmail" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="number" class="form-control" placeholder="Pincode" name="pincode" id="exampleInputPerEmail" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Qualification" name="qualification" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Semester" name="semester" value="">
															</div>
														</div>
													</div>
													...
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Branch/Stream" name="stream" id="exampleInputPerEmail" value="">
															</div>
														</div>
													</div>
													...
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Individual" name="account_type" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Institutions" name="institution_name" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																<input readonly type="text" class="form-control" placeholder="Referral Code" value="">
															</div>
														</div>
													</div>
													<div class="form-group ">
														<div class="row row-sm">
															...
															<div class="col-md-9">
																...
																<a target="_blank" href="../images/students/cv/"><button type="button" class="btn btn-primary mt-3 mb-0" name="upload_cv" style="text-align:right">Download</button></a>

															</div>
														</div>
													</div>
													<button type="button" class=" btn btn-info mt-3 mb-0"><a href="updatestudentprofile.php?id=&page=profile">Update
															Profile</a></button>
											</form>
										</div>
									</div>
