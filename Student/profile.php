					...
					<div class="col-lg-12 col-md-12">
						<div class="card custom-card">
							<div class="card-body d-md-flex">
								...
								&nbsp
<button class="btn btn-primary mb-3 shadow"><a href="../images/students/cv/"><span style="color:#ffffff;">CV Download</span></a></button> 
							...
							<div class="tab-content">
								<div class="main-content-body tab-pane active" id="about">
									<div class="card">
											...
											<!--	<div class="mb-4 main-content-label">Name</div> -->
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="date" class="form-control" id="dateMask"
																placeholder="DD/MM/YYYY" name="date_of_birth" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="Number" class="form-control"
																placeholder="10 Digit Number" name="phone_number" value="" >
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="number" class="form-control"
																placeholder="10 Digit Number" name="alternative_phone_number" value="" >
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control"
																placeholder="State" name="state" id="exampleInputPerEmail" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="number" class="form-control"
																placeholder="Pincode" name="pincode" id="exampleInputPerEmail" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control"
																placeholder="Qualification" name="qualification" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control"
																placeholder="Branch/Stream" name="stream" id="exampleInputPerEmail"  value="" >
														</div>
													</div>
												</div>
											<!--	<div class="mb-4 main-content-label">Social Info</div> -->
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control"
																placeholder="Individual" name="account_type" value="">
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input readonly type="text" class="form-control"
																placeholder="Institutions" name="institution_name" value=""
																>
														</div>
													</div>
												</div>
										...
										<button type="button" class=" btn btn-info mt-3 mb-0" ><a href="updatestudentprofile.php?id=&page=profile">Update Profile</a></button>		
											</form>   
										</div>
									</div>
								</div>
