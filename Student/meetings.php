...
$query = "SELECT *
FROM ((batches_meetings
INNER JOIN batch ON batches_meetings.batch_id = batch.id)
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="text-justified align-items-center">
                                                <h4 class="product-title mb-1"><b
                                                        style="color: #ff6700;"><?php echo $data['date_of_meeting_link']; ?></b>
                                                </h4>
                                                ...
                                                <p class="card-text tx-15"><span style="color: #13131a;">Platform 
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <?php echo $data['platform'];?>
                                                </p>
                                                <p class="card-text tx-15"><span style="color: #13131a;"> Meeting Link
                                                        &nbsp
                                                        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :</span>&nbsp &nbsp
                                                    <a href="<?php echo $data['meeting_link'];?>" target="_blank""><?php echo $data['meeting_link'];?></a></p>
