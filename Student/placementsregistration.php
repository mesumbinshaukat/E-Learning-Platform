...
<body class="ltr main-body app sidebar-mini">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
							<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Placement
								Registrations</span>
						</div>
					...
					<!--							<div class="card primary-custom-card">-->
					<!--								<div class="card-body">-->
					<!--									<div class="row">-->
					...
					<!--<h4 class="product-title mb-1"><b style="color: #ff6700;">Job Title</b>-->
					<!--											</h4>-->
					<!--										<p class="text-muted tx-13 mb-1">Stream</p> -->
					<!--										<br>-->
					<!--											<p class="card-text tx-16"><span style="color: #13131a;"><b> Company Name :</b></span>&nbsp Triaright Social</p>-->
					<!--                                <p class="card-text tx-16"><span style="color: #13131a;"><b>Salary :</b></span> &nbsp 10,000 INR </p>-->
					<!--                                <p class="card-text tx-16"><span style="color: #13131a;"><b>Category :</b></span> &nbsp work from home </p>-->
					<!--                                <p class="card-text tx-16"><span style="color: #13131a;"><b>Postings :</b></span> &nbsp 23 </p>-->
					<!--                                <p class="card-text tx-15"><span style="color: #13131a;"><b>Status :</b></span>&nbsp Pending </p>-->
					<!--								<div class="row">-->
					<!--<button class="btn btn-danger mb-3 shadow"><a href=""><span style="color:#ffffff;">Remove</span></a></button> &nbsp &nbsp-->
					<!--<button class="btn btn-info mb-3 shadow"><a href="fullplacementdetails.php"><span style="color:#ffffff;">View More</span></a></button> &nbsp &nbsp-->
					<!--</div>-->
					<!--											</div>-->
					<!--										</div>-->
					<!--									</div>-->
	...
	<div class="main-footer">
		<div class="container-fluid pd-t-0-f ht-100p">
			Copyright © 2023 <a href="www.triaright.com" class="text-primary">triaright</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="http://www.mycompany.co.in"> my company</a> . All
			rights reserved
		</div>
	</div>
	<!-- Footer closed -->
