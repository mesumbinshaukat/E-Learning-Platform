...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f898e0cef91AI-is-coming-—-and-HR-is-not-prepared.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-4 border-end">
											<div class="description-block">
												...
												<p class="card-text"><span style="color:#999999; Font-size:11px">Available Courses</span></p>
											</div>
										</div>
										<div class="col-sm-4 border-end">
											<div class="description-block">
												<h5 class="description-header">1679</h5>
												<p class="card-text"><span style="color:#999999; Font-size:11px">Registered Students</span></p>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="description-block">
												<h5 class="description-header">1660</h5>
												<p class="card-text"><span style="color:#999999; Font-size:11px">On-Going Students</span></p>
											</div>
										</div>
									</div>
								</div>
									<a class="btn btn-primary btn-block" href="viewcourses1.php?course=Information Technology">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8a0f800321NON IT 2.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
								...
								<div class="user-wideget-footer">
									...
									<a class="btn btn-primary btn-block" href="viewcourses1.php?course=Non IT">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8a231979e0finance.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
								...
								<div class="user-wideget-footer">
									...
									<a class="btn btn-primary btn-block" href="viewcourses1.php?course=Finance">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8a43890471pharmaceuticals.png"  alt="welcome" width="300" height="300">
								<div class="card-body">
								...
								<div class="user-wideget-footer">
									...
									<a class="btn btn-primary btn-block" href="viewcourses1.php?course=Pharmaceuticals">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8a53329c5aManagement.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
								...
								<div class="user-wideget-footer">
									...
									<a class="btn btn-primary btn-block" href="viewcourses1.php?course=Management">Check now</a>
								</div>
							 </div>
						</div>
