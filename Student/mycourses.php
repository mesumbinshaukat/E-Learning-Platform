										...
										<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
											<div class="text-justified align-items-center">
												...
												<div class="row">
													...
													<button class="btn btn-primary mb-3 shadow"><a href="schedule.php?batch_id=57"><span style="color:#ffffff;">Schedule</span></a></button>
													&nbsp &nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="meetings.php?batch_id=57"><span style="color:#ffffff;">Meetings</span></a></button>
													&nbsp &nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="summary.php?batch_id=57"><span style="color:#ffffff;">Summary</span></a></button> &nbsp
													&nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="recordings.php?batch_id=57"><span style="color:#ffffff;">Recordings</span></a></button>
													&nbsp &nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="tasks.php?batch_id=57"><span style="color:#ffffff;">Tasks</span></a></button> &nbsp
													&nbsp
													<button class="btn btn-primary mb-3 shadow"><a href="documentations.php?batch_id=57"><span style="color:#ffffff;">Documentations</span></a></button>
													&nbsp &nbsp
												</div>
												...
												<div class="row">
													...
													<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
														<div class="text-justified align-items-center">
															...
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Cateogry
																		:</b></span>&nbsp Individual</p>
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Payment :</b></span>&nbsp
																Individual</p>
															<p class="card-text tx-16"><span style="color: #13131a;"><b>
															...
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Batch Starting Date
																		:</b></span>&nbsp 2023-12-02</p>
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Batch Ending
																		Date:</b></span>&nbsp 2024-01-02</p>
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Session Slot
																		:</b></span>&nbsp Evening-2 </p>
															<p class="card-text tx-15"><span style="color: #13131a;"><b>Additional Information
																		:</b></span>&nbsp Na </p>
															...
															<div class="row">
																...
																<button class="btn btn-primary mb-3 shadow"><a href="meetings.php?batch_id=57"><span style="color:#ffffff;">Meetings</span></a></button>
																&nbsp &nbsp
																<button class="btn btn-primary mb-3 shadow"><a href="summary.php?batch_id=57"><span style="color:#ffffff;">Summary</span></a></button>
																&nbsp &nbsp
																<button class="btn btn-primary mb-3 shadow"><a href="recordings.php?batch_id=57"><span style="color:#ffffff;">Recordings</span></a></button>
																&nbsp &nbsp
																<button class="btn btn-primary mb-3 shadow"><a href="tasks.php?batch_id=57"><span style="color:#ffffff;">Tasks</span></a></button>
																&nbsp &nbsp
																<button class="btn btn-primary mb-3 shadow"><a href="documentations.php?batch_id=57"><span style="color:#ffffff;">Documentations</span></a></button>
																&nbsp &nbsp
															</div>
																			...
																			<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
																				<div class="text-justified align-items-center">
																					...
																					<p class="card-text tx-15"><span style="color: #13131a;"><b>Batch
																								...
																								Date:</b></span>&nbsp
																						2024-01-02</p>
																					<p class="card-text tx-15"><span style="color: #13131a;"><b>Session
																								Slot :</b></span>&nbsp
																						Evening-2 </p>
																					<p class="card-text tx-15"><span style="color: #13131a;"><b>Additional
																								Information
																						...
																						<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
																							<div class="text-justified align-items-center">
																								...
																								<p class="card-text tx-16">
																									<span style="color: #13131a;"><b>
																											Provider
																											Name
																											:</b></span>&nbsp
																									Triaright
																								</p>
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>
																											Course Fee
																											:</b></span>&nbsp
																									5400
																								...
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>Cateogry
																											:</b></span>&nbsp
																									Individual
																								</p>
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>Payment
																											:</b></span>&nbsp
																									Individual
																								</p>
																								<p class="card-text tx-16">
																								...
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>Batch
																											Starting
																											Date
																											:</b></span>&nbsp
																									2023-12-02
																								...
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>Session
																											Slot
																											:</b></span>&nbsp
																									Evening-2
																								</p>
																								<p class="card-text tx-15">
																									<span style="color: #13131a;"><b>Additional
																											Information
																											:</b></span>&nbsp
																									Na
																								</p>
																														...
																														<div class="col-sm-12 col-lg-12">
																															...
																															<div class="main-footer">
																																<div class="container-fluid pd-t-0-f ht-100p">
																																	...
																																	©
																																	2023
																																	<a href="www.triaright.in" class="text-primary">triaright</a>.
																																	Designed
																																	with
																																	<span class="fa fa-heart text-danger"></span>
																																	by
																																	<a href="www.mycompany.co.in">
																																		my
																																		company</a>
																																	.
																																	All
