                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img alt="img" class="d-block w-100"
                                            src="../superadmin/assets/img/placement/<?php echo $data['main_image'];?>"
                                            width="300" height="300">
                                    </div>
                                    <div class="carousel-item">
                                        <img alt="img" class="d-block w-100"
                                            src="../superadmin/assets/img/placement/<?php echo $data['image_two'];?>"
                                            width="300" height="300">
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-3"><span
                                            style="font-size:20px; color:#1d71f2; text-transform:none;"><?php echo $data['company_name'];?></span>
                                    </h4>
