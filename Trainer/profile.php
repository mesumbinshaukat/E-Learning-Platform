                                        ...
                                        <form class="form-horizontal">
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="text" class="form-control"
                                                            placeholder="Trainer Name" name="Trainer_Name"
                                                            id="exampleInputName" value="<?php echo $Fetching_trainer['name'] ?>">
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="Number" class="form-control"
                                                            placeholder="10 Digit Number" name="Personal_Phone_Number"
                                                            id="exampleInputName" disabled placeholder="" value="<?php echo $Fetching_trainer['contact_number'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="text" class="form-control"
                                                            placeholder="Email" name="Personal_mail_id"
                                                            id="exampleInputName" disabled placeholder="" value="<?php echo $Fetching_trainer['email'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="date" class="form-control" id="dateMask"
                                                            name="Date_Of_Birth" value="<?php echo $Fetching_trainer['dob'];?>" 
                                                            id="exampleInputName"  >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="number" class="form-control"
                                                            name="Aadhar_Card_No"
                                                            id="exampleInputName" disabled value="<?php echo $Fetching_trainer['aadhar_card_number'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="number" class="form-control"
                                                            placeholder="Pincode" name="Pan_Card_No"
                                                            id="exampleInputName" disabled placeholder="" value="<?php echo $Fetching_trainer['pan_card_number'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <a target="_blank" class="btn btn-primary mt-1 mb-0 mx-2"
                                                            style="text-align:right" href="../superadmin/assets/img/trainer/<?php echo $Fetching_trainer['pan_card_picture'];?>" download="">Download</a>
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="date" class="form-control" id="dateMask"
                                                            placeholder="DD/MM/YYYY" name="Date_Of_joining"
                                                            id="exampleInputName" disabled value="<?php echo $Fetching_trainer['date_of_joining'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="text" class="form-control"
                                                            ...
                                                            id="exampleInputName" disabled placeholder="" value="<?php echo $Fetching_trainer['qualification'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="text" class="form-control"
                                                            ...
                                                            id="exampleInputName" disabled placeholder="" value="<?php echo $Fetching_trainer['designation'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="Text" class="form-control"
                                                            name="any_experience" id="exampleInputName" disabled
                                                            value="<?php echo $Fetching_trainer['experience'];?>" placeholder="Expereince">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row row-sm">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input readonly type="text" class="form-control"
                                                            ...
                                                            name="prev_current_organization_name" id="exampleInputName"
                                                            disabled placeholder="" value="<?php echo $Fetching_trainer['organization_name'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
