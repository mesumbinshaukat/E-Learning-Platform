	 ...
	 include('./switcher.php'); 
	  ?>
		...
		<div class="page">
			...
			</div>			<form action="documentationlist1.php" method="POST" enctype="multipart/form-data">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Documentations List</span>
						</div>
