...
<link rel="icon" href="assets/img/icon.png" type="image/x-icon"/>
 ...
 <div class="sticky">
			...
			</div>			<form action="../superadmin/connection_files/create/trainer_schedule_create.php" method="POST" enctype="multipart/form-data">
			<!-- main-content -->
			<!-- main-content -->
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700"> Create Schedule</span>
						</div>
								...
								<div class="">
										<div class="row row-xs formgroup-wrapper">
									     <div class="col-md-6">
											...
											<!--	<input type="number" name="on_hand_expereince" class="form-control" min="1" max="100" id="exampleInputProEmail" placeholder="" >-->
											<!--</div>-->
											<!--</div>-->
										 ...
										 <!--   <div class="col-md-6">-->
											...
											<!--	<input class="form-control" name="Teaching" id="dateMask" placeholder="" min="1" max="100" type="number" >-->
											<!--</div>-->
											<!--</div>-->
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="file" name="Shared_Documents" class="form-control" id="exampleInputcode" placeholder="" >
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input name="Training_Starting_time" class="form-control" id="start-date" placeholder="" type="datetime-local" required>
											</div>
											</div>
                                            ...
                                            <div class="col-md-6">
												...
												<input name="Training_Ending_time" class="form-control" id="end-date" placeholder="" type="datetime-local" required>
    ...
    function checkDateRange() {
      ...
      if (startDate < endDate) {
		...
		return false;
											...
											<!--<div class="col-md-12">-->
											<!--<div class="form-group">-->
											<!--	<label for="exampleInputCompanyPhone">About the training </label>-->
											<!--	<textarea name="About_the_training" class="form-control" placeholder="Textarea"  rows="2" required></textarea>-->
											<!--</div>-->
											<!--</div>-->
									
										</div>
								<button type="submit" name="submit" onclick="return checkDateRange()" class="btn btn-info mt-3 mb-0" data-bs-target="#schedule" data-bs-toggle="modal" style="text-align:right">Schedule</button>
									</div>
								</div>
							</div>
						</div>
