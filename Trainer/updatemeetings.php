        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    &nbsp &nbsp <a href="https://www.microsoft.com/en-in/microsoft-teams/log-in"
                        class="btn btn-primary">Create Teams</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="">
                                    <div class="row row-xs formgroup-wrapper">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="date_of_meeting_link" id="dateMask"
                                                    required placeholder="MM/DD/YYYY"
                                                    value="<?php echo $meetings['date_of_meeting_link'] ?>" type="date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="Meeting_link"
                                                    value="<?php echo $meetings['meeting_link'] ?>" class="form-control"
                                    ...
                                    <button type="submit" name="UpdateBtn" class="btn btn-info mt-3 mb-0"
                                        ...
                                        style="text-align:right">Update Link</button>
                                </div>
                            </div>
                        </div>
                    </div>
