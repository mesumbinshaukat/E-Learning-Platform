...
if($insert_query_selector->execute()){
	...
	move_uploaded_file($supportive_documents_tmpname, "./assets/img/" . $supportive_documents_name);
...
<head>
 ...
 <?php include('./partials/sidebar.php')?>
			...
			</div><form action="" method="POST" entype="multipart/form-data">
									...
									<div class="">
										<div class="row row-xs formgroup-wrapper">
											<div class="col-md-6">
												...
												<input type="text" name="course_name" class="form-control" required id="exampleInputName" placeholder="Enter Course Name">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone"> Course Description</label>
												<textarea class="form-control" required name="course_description" placeholder="Textarea" rows="2"></textarea>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone">Topics to be covered</label>
												<textarea class="form-control" required name="topics_to_be_covered" placeholder="Textarea" rows="2"></textarea>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone"> Duration</label>
												<input type="number" class="form-control" required name="duration" id="exampleInputPersonalPhone" placeholder="duration of Course">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone">Benefits of Course</label>
												<textarea class="form-control" required placeholder="Textarea" name="benefits" rows="2"></textarea>
											</div>
											</div>
										...
										<select  class="form-control form-select select2" required name="training_type" data-bs-placeholder="Select Country">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" required name="suitable_student_qualification" id="exampleInputQualification" placeholder="Enter qualification">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone">Pre-requirements</label>
												<textarea class="form-control" required placeholder="Textarea" name="pre_requirements" rows="2"></textarea>
											</div>
											</div>
											...
											<div class="form-group">
												...
												<input type="number" required class="form-control" id="exampleInputAadhar" name="cost_of_course" placeholder="Course cost">
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input class="form-control" required id="number" placeholder="00:00" name="hours_per_day" type="number">
											</div>
											</div>
											...
											<div class="form-group">
												...
												<input type="file" required class="form-control" id="exampleInputcode" name="supportive_documents" placeholder="">
											</div>
											</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" required class="form-control"  id="exampleInputcode" name="additional_info" placeholder="Additional information">
											</div>
											</div>
										
						
										<input type="submit" name="suggestBtn" value="Suggest a Course" class="btn btn-primary mt-3 mb-0" data-bs-target="#suggest" data-bs-toggle="modal" style="text-align:right">
										</div>
									</div>
								</div>
							</div>
