...
<head>
 ...
 <div class="sticky">
							...
							<div class="card-body d-md-flex">
								<div class="">
									...
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
											...
											class="font-weight-semibold me-2">Phone:</span><span><?php echo $Fetching_trainer['contact_number']?></span>
									</p>
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
												class="fa fa-envelope me-2"></i></span><span
											class="font-weight-semibold me-2">Email:</span><span><?php echo $Fetching_trainer['email']?></span>
									</p>
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
												class="far fa-flag me-2"></i></span><span
											class="font-weight-semibold me-2">Designation:</span><span><?php echo $Fetching_trainer['designation']?></span>
									</p>
											...
											<!--	<div class="mb-4 main-content-label">Name</div> -->
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Trainer Name" name="Trainer_Name" id="exampleInputName" value="<?php echo $Fetching_trainer['name']?>">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Trainer Username" name="Trainer_Username" id="exampleInputName" value="<?php echo $Fetching_trainer['username']?>">
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input  type="Number" class="form-control"
																placeholder="Enter Phone Number" name="Personal_Phone_Number" id="exampleInputName" min="0"	 placeholder="" value="<?php echo $Fetching_trainer['contact_number']?>">
														</div>
													</div>
												</div>
												<div class="form-group ">
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="date" class="form-control" id="dateMask"
																placeholder="DD/MM/YYYY" name="Date_Of_Birth" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['dob']?>">
														</div>
													</div>
												</div>
											<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" min="0"	 class="form-control"
																placeholder="Pincode" name="Aadhar_Card_No" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['aadhar_card_number']?>">
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																placeholder="Enter Pincode" min="0"	  name="Pan_Card_No" id="exampleInputName" placeholder="" value="<?php echo $Fetching_trainer['pan_card_number']?>">
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="date" class="form-control" id="dateMask"
																placeholder="DD/MM/YYYY" name="Date_Of_joining" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['date_of_joining']?>">
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Enter Qualification" name="Qualification" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['qualification']?>" >
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Enter Designation" name="Designation" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['designation']?>" >
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Enter Previous Organization Name" name="prev_current_organization_name" id="exampleInputName"  placeholder="" value="<?php echo $Fetching_trainer['organization_name']?>">
														</div>
													</div>
												</div>
													<div class="form-group ">
        ...
        <!-- BACK-TO-TOP -->
		<a href="updatetrainerprofile.php@Id=19.html#top" id="back-to-top"><i class="las la-arrow-up"></i></a>
