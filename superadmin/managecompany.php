			...
			<div class="main-container container-fluid">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="right-content">
						<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Manage Company</span>
					</div>
				...
				<form method="post">
					<div class="row row-sm">
						...
						<div class="form-group col-md-3">
							...
							<select name="cons_emp" class="form-control form-select" data-bs-placeholder="Select Filter">
								<option value="All" selected="selected">All</option>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=1" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=1&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=1" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=1&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=1&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=1&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=4" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=4&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=4" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=4&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=4&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=4&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=5" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=5&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=5" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=5&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=5&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=5&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=6" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=6&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=6" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=6&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=6&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=6&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=7" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=7&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=7" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=7&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=7&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=7&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=8" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=8&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=8" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=8&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=8&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=8&unblock=unblock">unblock</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewcompany.php?id=12" class="dropdown-item">view</a>
															<a href="updatecompany.php?id=12&page=manage" class="dropdown-item">update</a>
															<!--<a href="deletecompany.php?id=12" class="dropdown-item">Delete</a>
														<a data-bs-target="#block" data-bs-toggle="modal" class="dropdown-item">Block</a>
														<a data-bs-target="#unblock" data-bs-toggle="modal" class="dropdown-item">unBlock</a> -->

															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=12&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=12&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/company_manage.php?id=12&unblock=unblock">unblock</a>
...
</html>                                <h6 class="modal-title">confirmation Notification</h6><button aria-label="Close"
