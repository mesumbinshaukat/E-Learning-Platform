					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="alloc.php@crid=5.html" class="header-logo">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="alloc.php@crid=5.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/superadmin/assets/img/faces/2.jpg" class=""></a>
...
<br>	-->
					...
					<td><a href="https://triaright.com/superadmin/coursestudentallocation.php?crid=5&amp;trid=19" class="btn btn-info">allocate</a></td>
					...
					<td><a href="https://triaright.com/superadmin/coursestudentallocation.php?crid=5&amp;trid=44" class="btn btn-info">allocate</a></td>
        ...
        <!-- BACK-TO-TOP -->
		<a href="alloc.php@crid=5.html#top" id="back-to-top"><i class="las la-arrow-up"></i></a>
