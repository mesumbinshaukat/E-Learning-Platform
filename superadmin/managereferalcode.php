 			...
 			<div class="main-container container-fluid">
 				...
 				<div class="breadcrumb-header justify-content-between">
 					<div class="right-content">
 						<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Manage Referal Code </span>
 					</div>

 					<div class="justify-content-center mt-2">
 						<ol class="breadcrumb">
 							<li class="breadcrumb-item tx-14"><a href="javascript:void(0);">Courses</a></li>
 							<li class="breadcrumb-item ">Referal Code</li>
 				...
 				<form method="post">
 					<div class="row row-sm">
 						<div class="form-group col-md-3">
 							<b> <label>Referal Code</label> </b>

 							<select name="Referal_Code" class="form-control form-select" data-bs-placeholder="Select Filter">

 								<option value="ALL" selected="selected">ALL</option>
 								<option value="TRPYT20">TRPYT20</option>
 						...
 						<div class="form-group col-md-3">
 							...
 							<select name="created_by" class="form-control form-select" data-bs-placeholder="Select Filter">
 										...
 										<tbody>
											...
											<button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
													...
													<div class="dropdown-menu">
														<a href="viewreferalcode.html" class="dropdown-item">view</a>
														<a href="updatereferalcode.html" class="dropdown-item">update</a>
														<a href="viewreferalcodeusage.html" class="dropdown-item">view usage</a>
														<a data-bs-target="#pause" data-bs-toggle="modal" class="dropdown-item">Pause</a>
														<a data-bs-target="#resume" data-bs-toggle="modal" class="dropdown-item">Resume</a>
														<a data-bs-target="#Delete" data-bs-toggle="modal" class="dropdown-item">Delete</a>
 					...
 					<div class="modal-dialog" role="document">
 						<div class="modal-content modal-content-demo">
 							...
 							<div class="modal-body">
 								...
 								<p> Are you sure you want to Delete a referal code?</p>
 							</div>
 					...
 					<div class="modal-dialog" role="document">
 						<div class="modal-content modal-content-demo">
 							...
 							<div class="modal-body">
 								...
 								<p> Are you sure you want to pause a referal code?</p>
 							</div>
 							<div class="modal-footer">
 					...
 					<div class="modal-dialog" role="document">
 						<div class="modal-content modal-content-demo">
 							...
 							<div class="modal-body">
 								...
 								<p> Are you sure you want to resume a referal code?</p>
 							</div>
 							<div class="modal-footer">
 ...
 </html>     <script src="assets/plugins/jquery/jquery.min.js"></script>
