...
<head>
	...
	<div class="switcher-wrapper">
		...
		<div class="page">
			...
			</div><form action="addtask1.php" method="POST" enctype="multipart/form-data">
			<!-- main-content -->
			<!-- main-content -->
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700"> Add Task</span>
						</div>
					...
					<!-- /breadcrumb -->
							...
							<div class="form-group col-md-4">
	                               <select name="batch_id" required class="form-control form-select select2" data-bs-placeholder="Select Batch">
																				<option value="1">TRSTBA_1Nandamuru Koteswara RaoMedical Coding</option>

											<option value="2">TRSTBA_2M Sandeep KumarDigital Marketing</option>

											<option value="3">TRSTBA_3Uma Kiran VMedical Coding</option>

											<option value="4">TRSTBA_4Uma Kiran VMedical Coding</option>

											<option value="5">TRSTBA_5V Bala Tripura SunadriJAVA</option>

											<option value="6">TRSTBA_6V Bala Tripura SunadriJAVA</option>

											<option value="7">TRSTBA_7V Bala Tripura SunadriPython</option>

											<option value="8">TRSTBA_8SRIKANTH Cloud computing</option>

											<option value="9">TRSTBA_9Nikhil ChakkaPython</option>

											<option value="10">TRSTBA_10Shaik Ashraf rahilWeb Technologies</option>

											<option value="11">TRSTBA_11Shaik Ashraf rahilWeb Technologies</option>

											<option value="12">TRSTBA_12Senthan M S V SPython</option>

											<option value="13">TRSTBA_13Shiva KrishnaDigital Marketing</option>

											<option value="14">TRSTBA_14saitejaswi kolliboinaMedical Coding</option>

											<option value="15">TRSTBA_15VasundharaTally</option>

											<option value="16">TRSTBA_16NarenderUS Taxation</option>

											<option value="17">TRSTBA_17Madhu VarshiniHuman resource management</option>

											<option value="18">TRSTBA_18saitejaswi kolliboinaMedical Coding</option>

											<option value="20">TRSTBA_20Saieshwari GoguDigital Marketing</option>

											<option value="23">TRSTBA_23tirdhala ashokWeb Technologies</option>

											<option value="24">TRSTBA_24G VenkateshCloud computing</option>

											<option value="26">TRSTBA_26V Bala Tripura SunadriPython</option>

											<option value="27">TRSTBA_27V Bala Tripura SunadriJAVA</option>

											<option value="28">TRSTBA_28Saieshwari GoguDigital Marketing</option>

											<option value="29">TRSTBA_29Mekanaboyina Venkata murali KrishnaTally</option>

											<option value="30">TRSTBA_30Madhu VarshiniHuman resource management</option>

											<option value="31">TRSTBA_31tirdhala ashokWeb Technologies</option>

											<option value="32">TRSTBA_32RamuMedical Coding</option>

											<option value="34">TRSTBA_34Madanu AugustinAI </option>

											<option value="37">TRSTBA_37Madanu AugustinPower BI </option>

											<option value="38">TRSTBA_38Akhila VMy SQL </option>

											<option value="39">TRSTBA_39vijay kumar sampathiMedical Coding</option>

											<option value="40">TRSTBA_40Tiruvidhula Naga Sai PriyankaJAVA</option>

											<option value="41">TRSTBA_41Srinivas Yerrravelli	Digital Marketing</option>

											<option value="42">TRSTBA_42V Bala Tripura SunadriJAVA</option>

											<option value="43">TRSTBA_43V Bala Tripura SunadriJAVA</option>

											<option value="44">TRSTBA_44RamuMedical Coding</option>

											<option value="45">TRSTBA_45tirdhala ashokWeb Technologies</option>

											<option value="47">TRSTBA_47tirdhala ashokWeb Technologies</option>

											<option value="48">TRSTBA_48Madhu VarshiniHuman resource management</option>

											<option value="50">TRSTBA_50Srinivas YerrravelliDigital Marketing</option>

											<option value="51">TRSTBA_51Shanti KiranPython</option>

											<option value="52">TRSTBA_52K Bharath KumarTally   GST</option>

											<option value="54">TRSTBA_54V Bala Tripura SunadriJAVA</option>

											<option value="55">TRSTBA_55RamuMedical Coding</option>

											<option value="56">TRSTBA_56tirdhala ashokWeb Technologies</option>

											<option value="57">TRSTBA_57demotrainerVoice process</option>

											<option value="58">TRSTBA_58M Sandeep KumarDigital Marketing</option>

											<option value="59">TRSTBA_59M Sandeep KumarDigital Marketing</option>

											<option value="60">TRSTBA_60V Bala Tripura Sunadri	Python</option>

											<option value="61">TRSTBA_61Kishore Kumar Human resource management</option>

											<option value="62">TRSTBA_62Shanti KiranPython</option>
