...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Employee List </span> 
						</div>
									...
									<div class="card-body">
										...
										<div class="table-responsive  export-table">
                                         ...
                                         <tr>
	                                         ...
	                                         <td>1 </td>
	                                         <td>2023-04-20 13:38:37</td>
	                                         <td>superadmin@gmail.com</td>
	                                         <td>TREMP_8</td>
	                                         <td>balats</td>
		                                      <td>executive</td>
											  		                                     <b> <td style=color:#4aa02c>
			                                  <b>  Active <b></td>
