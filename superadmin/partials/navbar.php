    ...
    <div class="main-header-left ">
        ...
        <div class="app-sidebar__toggle" data-bs-toggle="sidebar">
            <a class="close-toggle" href="javascript:void(0);"><i
                    class="header-icon bi bi-chevron-double-right"></i></a>
            <a class="open-toggle" href="javascript:void(0);"><i class="header-icon bi bi-x-lg"></i></a>
        </div>
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content p-3 border-bottom">
                                <div class="d-flex wd-100p">
                                    <div class="main-img-user"><img alt="" src="assets/icons/add-user.png" class="">
                                    </div>
