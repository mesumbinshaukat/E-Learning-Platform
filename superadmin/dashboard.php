                    ...
                    <div class="main-header-left ">
                        <div class="responsive-logo">
                            <a href="" class="header-logo">
                                <img src="assets/img/WordPress_blue_logo.svg-min.webp" class="mobile-logo logo-1"
                                    alt="logo">
                                <img src="assets/img/WordPress_blue_logo.svg-min.webp" class="mobile-logo dark-logo-1"
                                    alt="logo">
                            </a>
                        </div>
                        <div class="app-sidebar__toggle" data-bs-toggle="sidebar">
                            <a class="open-toggle" href="javascript:void(0);"><i
                                    class="header-icon bi bi-distribute-vertical"></i></a>
                            <a class="close-toggle" href="javascript:void(0);"><i
                                    class="header-icon bi bi-x-lg"></i></a>
                        </div>
