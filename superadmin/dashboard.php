...
<div class="row">
						...
						<a href="candidatesignup.php" style="color:#1D71F2"><p class="font-weight-bold tx-24">16</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Pending</label>
<a href="pendingstudent.php" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
						</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Total </label>
<a href="studentlist.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">5049</p></a>
										</div><!-- col -->
...
<a href="studentlist.php?type=rejected" style="color:#FF0000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="studentlist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">1</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="studentlist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">5032</p></a>
										</div><!-- col -->
								
								<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="studentlist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Sign up</label>
						<a href="collegesignup.php" style="color:#1D71F2"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Pending</label>
<a href="pendingcollege.php" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
						</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Total</label>
<a href="collegelist.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">55</p></a>
										</div><!-- col -->
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Rejected</label>
<a href="collegelist.php?type=rejected" style="color:#FF0000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="collegelist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="collegelist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">55</p></a>
										</div><!-- col -->
														<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="collegelist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Sign up</label>
						<a href="companysignup.php" style="color:#1D71F2"><p class="font-weight-bold tx-24">9</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Pending</label>
<a href="pendingcompany.php" style="color:#FF6700"><p class="font-weight-bold tx-24">1</p></a>
						</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Total</label>
<a href="managecompany.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">20</p></a>
										</div><!-- col -->
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Rejected</label>
<a href="companylist.php?type=rejected" style="color:#FF0000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="companylist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="companylist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">7</p></a>
										</div><!-- col -->
														<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="companylist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">3</p></a>
										</div><!-- col -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col border-start text-center">
											<label class="tx-12">Total</label>
<a href="managementor.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">14</p></a>
										</div><!-- col -->
...
<!--										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="mentorlist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="mentorlist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">14</p></a>
										</div><!-- col -->
																<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="mentorlist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Sign up</label>
						<a href="trainersignup.php" style="color:#1D71F2"><p class="font-weight-bold tx-24">6</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Pending</label>
<a href="pendingtrainer.php" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
						</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Total</label>
<a href="trainerlist.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">43</p></a>
										</div><!-- col -->
								...
								<div class="card-body">
									<div class="row">
										<div class="col text-center">
											<label class="tx-12">Rejected</label>
<a href="trainerlist.php?type=rejected" style="color:#FF0000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="trainerlist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="trainerlist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">34</p></a>
										</div><!-- col -->
											<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="trainerlist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">3</p></a>
										</div><!-- col -->								
									</div><!-- row -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col border-start text-center">
											<label class="tx-12">Total</label>
<a href="manageemployee.php" style="color:#4AA02C"><p class="font-weight-bold tx-24">8</p></a>
										</div><!-- col -->
...
<!--										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Block</label>
							<a href="employeelist.php?type=block" style="color:#FF6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Active</label>
										<a href="employeelist.php?type=active" style="color:#4AA02C"><p class="font-weight-bold tx-24">8</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-12">Delete</label>
										<a href="employeelist.php?type=delete" style="color:#000000"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->								
									</div><!-- row -->
...
<a href="managecourseregistrations.php" style="color:#1d71f2"><p class="font-weight-bold tx-24">14922500</p></a>
										</div>
							...
							<!--			</div>-->
										...
										<a href="paymentslist.php?type=receivedcollege" style="color:#4AA02c"><p class="font-weight-bold tx-24">10000</p></a>
										</div><!-- col --> 
												
							
																				<div class="col border-start text-center">
											<label class="tx-14">Received individuals </label>
										<a href="paymentslist.php?type=receivedindividuals" style="color:#4AA02c"><p class="font-weight-bold tx-24">2147968289</p></a>
										</div><!-- col --> 
											
																			
<div class="col border-start text-center">
											<label class="tx-14">Hold </label>
<a href="paymentslist.php?type=hold" style="color:#ff6700"><p class="font-weight-bold tx-24"></p></a>
										</div><!-- col -->
								
											<div class="col border-start text-center">
											<label class="tx-14">Remaining</label>
<a href="paymentslist.php?type=remaining" style="color:#ff0000"><p class="font-weight-bold tx-24">-2133055789</p></a>
										</div><!-- col -->
														
									<div class="col border-start text-center">
											<label class="tx-14">Rejected </label>
<a href="paymentslist.php?type=rejected" style="color:#000000"><p class="font-weight-bold tx-24">2147502852</p></a>
										</div><!-- col -->
	...
	<a href="internshipcompanylist.php"  style="color:#1d71f2"><p class="font-weight-bold tx-24">1</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-14">Companies</label>
							<a  style="color:#1d71f2" href="managecompanyinternship.php"><p class="font-weight-bold tx-24">1</p></a>
										</div><!-- col -->
									<div class="col border-start text-center">
											<label class="tx-14">Vacancies</label>
										<a href="managecompanyinternship.php" style="color:#1d71f2"><p class="font-weight-bold tx-24">50</p></a>
										</div><!-- col --> 
																			
<div class="col border-start text-center">
											<label class="tx-14">Applicants</label>
<a href="internshipregistrationlist.php" style="color:#000000"><p class="font-weight-bold tx-24">12</p></a>
										</div><!-- col -->
								
											<div class="col border-start text-center">
											<label class="tx-14">Hold</label>
<a href="pendinginternshipregistrations.php" style="color:#ff6700"><p class="font-weight-bold tx-24">2</p></a>
										</div><!-- col -->
								
									<div class="col border-start text-center">
											<label class="tx-14">Selected </label>
<a href="internshipregistrationlist.php?type=selected" style="color:#4AA20C"><p class="font-weight-bold tx-24">9</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-14">Not selected & Deleted </label>
<a href="internshipregistrationlist.php?type=notselected" style="color:#FF0000"><p class="font-weight-bold tx-24">1</p></a>
										</div><!-- col -->
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="card-title pb-0  mb-2">Placements</div>
										...
										<div class="col text-center">
											<label class="tx-14">Listed</label>
<a href="placementcompanylist.php" style="color:#1d71f2"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-14">Companies</label>
							<a  style="color:#1d71f2"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
									<div class="col border-start text-center">
											<label class="tx-14">Vacancies</label>
										<a href="placementcompanylist.php" style="color:#1d71f2"><p class="font-weight-bold tx-24"></p></a>
										</div><!-- col --> 
																			
<div class="col border-start text-center">
											<label class="tx-14">Applicants</label>
<a href="placementcompanylist.php" style="color:#000000"><p class="font-weight-bold tx-24">4</p></a>
										</div><!-- col -->
								
											<div class="col border-start text-center">
											<label class="tx-14">Hold</label>
<a href="pendingplacementsregistrations.php" style="color:#ff6700"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
								
									<div class="col border-start text-center">
											<label class="tx-14">Selected </label>
<a href="placementsregistrationlist.php?type=selected" style="color:#4AA20C"><p class="font-weight-bold tx-24">0</p></a>
										</div><!-- col -->
										<div class="col border-start text-center">
											<label class="tx-14">Not selected & Deleted </label>
<a href="placementsregistrationlist.php?type=notselected" style="color:#FF0000"><p class="font-weight-bold tx-24">4</p></a>
										</div><!-- col -->
