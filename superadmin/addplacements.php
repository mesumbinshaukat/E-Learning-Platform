								...
								<div class="card-body">
									...
									<div id="wizard3">
										...
										<select name="industry" class="form-control form-select select2" data-bs-placeholder="Select Stream" required>
										 ...
										 <option value="Information Technology">Information Technology</option>  <option value="Non IT">Non IT</option>  <option value="Finance">Finance</option>  <option value="Pharmaceuticals">Pharmaceuticals</option>  <option value="Management">Management</option>  <option value="event">event</option>  <option value="TESTING">TESTING</option> 										
										</select>
											</div>
										<div class="control-group form-group mb-2">		
