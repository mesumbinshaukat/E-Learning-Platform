...
<div class="main-sidebar-header active">
			...
			</div><form action="connection_files/create/referal_code_create.php" method="POST" enctype="multipart/form-data">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">add Referal Code</span>
						</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="">
										...
										<select id="dropdown1" onchange="showOptions1()" class="form-control form-select select2" data-bs-placeholder="Performer" name="Login_Type" required>
											<option></option>
...
`;
				...
				document.getElementById("optionsDiv").innerHTML = '';
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="exampleInputPersonalPhone" placeholder="Enter Referal Code" name="Referal_Code" required>
											</div>
											</div>
										 <div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputDOB">Starting Time</label>
												<input class="form-control" id="start-date" placeholder="MM/DD/YYYY" type="date" name="Starting_Time" required>
											</div>
											</div>
											 <div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputDOB">Ending Time</label>
												<input class="form-control" id="end-date" placeholder="MM/DD/YYYY" type="date" name="Ending_Time" required>
    ...
    function checkDateRange() {
      ...
      if (startDate < endDate) {
        ...
        document.getElementById("message").textContent = "Start date is greater than or equal to end date.";
		return false;
      }
    }
  </script>
											...
											<div class="form-group">
												...
												<input type="number" class="form-control" id="exampleInputProEmail" placeholder="0-100 %" min="1" max="100" name="Discount" required>
											</div>
											</div>
											...
											<div class="form-group">
												...
												<input type="number" class="form-control" min="1" id="exampleInputProEmail" placeholder="" name="Times_of_Usage" required>
											</div>
											</div>
								...
								<button type="submit" name="submit" onclick="return checkDateRange()" class="btn btn-info mt-3 mb-0" data-bs-target="#schedule" data-bs-toggle="modal" style="text-align:right">Add Referal Code</button>
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to add referal code?</p>
                                </div>
