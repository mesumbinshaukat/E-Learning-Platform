...
<body class="ltr main-body app sidebar-mini">
	...
	<div class="page">
		...
		<form action="connection_files/create/suggestions_create.php" method="POST" enctype="multipart/form-data">
										...
										<div class="row row-xs formgroup-wrapper">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputName" placeholder="Enter Name" name="name_of_the_Course" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputCompanyPhone"> Course Description</label>
													<input type="text" class="form-control" placeholder="text" name="Course_Description" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputCompanyPhone">Topics to be covered</label>
													<input type="text" class="form-control" placeholder="Text" name="Topics_to_be_covered" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputPersonalPhone"> Duration(Days)</label>
													<input type="number" class="form-control" id="exampleInputPersonalPhone" min="1" placeholder="duration of Course" name="Duration" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputCompanyPhone">Benefits of Course</label>
													<input type="text" class="form-control" placeholder="Text" name="Benefits_of_Course" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="form-control form-select select2" data-bs-placeholder="Select Country" name="Training_Type" required>
														<option value="Hybrid">Hybrid</option>
														<option value="Offline">Offline</option>
														<option value="Virtual_Live_Sessions">Virtual Live Sessions</option>
														<option value="Virtual_Recorded_Sessions">Virtual Recorded Sessions</option>
													</select>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputQualification" placeholder="Enter qualification" name="suitable_student_qualification" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputCompanyPhone">Pre-requirements</label>
													<input type="text" class="form-control" placeholder="Text" name="Pre_requirements" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" class="form-control" id="exampleInputAadhar" min="1" placeholder="Course cost" name="Approx_Cost_for_Course" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="exampleInputAadhar">name of designation</label>
													<select class="form-control form-select select2" data-bs-placeholder="Select Country" name="name_of_designation" required>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input class="form-control" id="number" min="1" placeholder="00:00" type="number" name="Hours_per_day" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="file" class="form-control" id="exampleInputcode" placeholder="" name="Supportive_documents" required>
												</div>
											</div>
											...
											<button type="submit" name="submit" class="btn btn-primary mt-3 mb-0" data-bs-target="#suggest" data-bs-toggle="modal" style="text-align:right">Generate</button>
										</div>
									</div>
								</div>
							</div>
...
</html>                                    <p> Are you sure you want to suggest a Course??</p>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn ripple btn-success" type="button">Create</button>
                                    <button class="btn ripple btn-secondary" data-bs-dismiss="modal" type="button">Not Now</button>
