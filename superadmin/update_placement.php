...
if (isset($_POST["Update"])) {
    ...
    $years_open_experience = $_POST["years_open_experience"];
    ...
    $inner_image_old_two = $_POST["inner_image_old_two"];
    ...
    if (empty($_FILES["inner_image_two"]["name"])) {
        $inner_image_two = $inner_image_old_two;
    } else {
        $inner_image_two = $_FILES["inner_image_two"]["name"];
        $inner_image_tmp_two = $_FILES["inner_image_two"]["tmp_name"];
    }

    $update_query = mysqli_prepare($conn, "UPDATE `placement` SET `company_name`=?,`job_role`=?,`salary`=?,`industry`=?,`experience`=?,`work_mode`=?,`years_open_experience`=?,`eligibility`=?,`location`=?,`job_type`=?,`gender`=?,`vacancies`=?,`last_date_to_apply`=?,`full_description`=?,`requirements`=?,`additional_info`=?,`food_allowances`=?,`transport_allowances`=?,`esi`=?,`main_image`=?,`inner_image`=?,`image_two`=? WHERE `id`=?");
    $update_query->bind_param("ssssssssssssssssssssssi", $company_name, $job_role, $salary, $industry, $experience, $work_mode, $years_open_experience, $eligibility, $location, $category, $gender, $vacancies, $last_date_to_apply, $full_description, $requirements, $additional_info, $food_allowances, $transport_allowances, $esi, $main_image, $inner_image, $inner_image_two, $id);
    if ($update_query->execute()) {
        if ($main_image != $main_image_old) {
            move_uploaded_file($main_image_tmp, "./assets/img/placement/" . $main_image);
        }
        if ($inner_image != $inner_image_old) {
            move_uploaded_file($inner_image_tmp, "./assets/img/placement/" . $inner_image);
        }
        if ($inner_image_two != $inner_image_old_two) {
            move_uploaded_file($inner_image_tmp_two, "./assets/img/placement/" . $inner_image_two);
        }
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="left-content">
                        <span class="main-content-title mg-b-0 mg-b-lg-1">Manage Placement</span>
                    </div>
                                        ...
                                        <div id="wizard3">
                                            ...
                                            <section>
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <input type="text" name="job_role" class="form-control" placeholder="Title" value="<?php echo $fetch['job_role']; ?>">
                                                </div>
                                                <div class="control-group form-group">
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <input type="number" name="salary" class="form-control" placeholder="Salary" value="<?php echo $fetch["salary"] ?>">
                                                </div>
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <select class="form-control form-select select2" name="category">
                                                        <?php
                                                        switch ($fetch["job_type"]) {
                                                            case "FullTime":
                                                                echo '<option value="FullTime" selected>Full Time</option>';
                                                                echo '<option value="PartTime">Part Time</option>';
                                                                break;
                                                            case "PartTime":
                                                                echo '<option value="FullTime" >Full Time</option>';
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <select class="form-control form-select select2" name="experience">

                                                        <?php
                                                        switch ($fetch["experience"]) {
                                                            case "Fresher":
                                                                echo '<option selected value="Fresher">Fresher</option>';
                                                                echo '<option value="Experience">Experience</option>';
                                                                echo '<option value="Both">Both</option>';
                                                                break;
                                                            case "Experience":
                                                                echo '<option value="Fresher">Fresher</option>';
                                                                echo '<option selected value="Experience">Experience</option>';
                                                                echo '<option value="Both">Both</option>';
                                                                break;
                                                            case "Both":
                                                                echo '<option value="Fresher">Fresher</option>';
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Years Of Experience" name="years_open_experience" value="<?php echo $fetch["years_open_experience"] ?>">
                                                </div>
                                                <div class="control-group form-group">
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <select class="form-control form-select select2" name="work_mode">
                                                        <?php
                                                        switch ($fetch["work_mode"]) {
                                                            case "WorkfromHome":
                                                                echo '<option value="WorkfromHome" selected>Work from Home</option>';
                                                                echo '<option value="WorkFromoffice">Work From office</option>';
                                                                echo '<option value="Hybrid">Hybrid</option>';
                                                                break;
                                                            case "WorkFromoffice":
                                                                echo '<option value="WorkfromHome" >Work from Home</option>';
                                                                echo '<option value="WorkFromoffice" selected>Work From office</option>';
                                                                echo '<option value="Hybrid">Hybrid</option>';
                                                                break;
                                                            case "Hybrid":
                                                                echo '<option value="WorkfromHome" >Work from Home</option>';
                                            ...
                                            <section>
                                                ...
                                                <div class="form-label">
                                                    <input class="form-control" placeholder="Textarea" name="full_description" rows="5" value="<?php echo $fetch["full_description"] ?>"></input>
                                                </div>


                                                <label class="form-label"> Pre-Requirements</label>
                                                <div class="form-label">
                                                    <input class="form-control" name="requirements" placeholder="Textarea" rows="5" value="<?php echo $fetch["requirements"] ?>"></input>
                                                </div>
                                            ...
                                            <section>
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <select class="form-control form-select select2" name="esi">
                                                        <?php
                                                        switch ($fetch["esi"]) {
                                                            case "Yes":
                                                                echo "<option selected value='Yes'>Yes</option>";
                                            ...
                                            <section>
                                                ...
                                                <div class="control-group form-group">
                                                    ...
                                                    <a target="_blank" href="./assets/img/placement/<?php echo $fetch["main_image"] ?>" class="btn btn-primary mt-3 mb-0" style="text-align:right">View Main
                                                        Image</a>
                                                </div>
                                                <div class="control-group form-group">
                                                    ...
                                                    <a href="<?php echo "./assets/img/placement/" . $fetch["inner_image"] ?>" class="btn btn-primary mt-3 mb-0" style="text-align:right" target="_blank">View Inner Image</a>
                                                </div>
                                                <div class="control-group form-group">
                                                    <label class="form-label">Inner Two</label>
                                                    <input type="file" name="inner_image_two" class="form-control">
                                                    <input type="hidden" name="inner_image_old_two" value="<?php echo $fetch["image_two"] ?>">
                                                    <a href="<?php echo "./assets/img/placement/" . $fetch["image_two"] ?>" class="btn btn-primary mt-3 mb-0" style="text-align:right" target="_blank">View Inner Image Two</a>
                                                </div>
                                                <div class="control-group form-group">
