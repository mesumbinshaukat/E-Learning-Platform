			...
			<div class="main-container container-fluid">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="right-content">
						<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Add Internship Registrations</span>
					</div>
								...
								<div class="table-responsive  export-table">
									<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
										...
										<tbody>
											...
											<!--	<td>Admin</td>-->
											<!--	<td>TRINT_001</td>-->
											<!--	<td>Tele Marketing intern</td>-->
											<!--	<td>140</td>-->
											<!--	<td>12/12/2023</td>-->
											<!--	<td><a href="selectstudent.html" class="btn btn-info">add Student</a></td>-->
											<!--</tr>-->
											<!--<tr>-->
											<!--	<td>01</td>-->
											<!--	<td>23/11/2022 14:00:23</td>-->
