...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Manage allocate Trainers </span> 
						</div>
...
<br>	
					...
					<td>Medical Coding</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=4" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=4&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Digital Marketing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=5" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=5&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Medical Transcription</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=18" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=18&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>JAVA</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=19" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=19&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Cloud computing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=24" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=24&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Python</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=27" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=27&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Web Technologies</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=28" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=28&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Python</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=30" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=30&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Digital Marketing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=31" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=31&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Medical Coding</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=36" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=36&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Tally</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=38" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=38&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>US Taxation</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=39" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=39&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Human resource management</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=40" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=40&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Python</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=35" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=35&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Digital Marketing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=41" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=41&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Web Technologies</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=44" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=44&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Cloud computing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=46" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=46&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Tally</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=47" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=47&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Python</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=49" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=49&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Medical Coding</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=45" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=45&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>AI </td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=50" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=50&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>My SQL </td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=56" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=56&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>JAVA</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=52" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=52&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Digital Marketing</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=61" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=61&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Python</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=57" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=57&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Medical Coding </td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=62" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=62&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Tally   GST</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=63" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=63&delete=delete" class="btn btn-danger">Delete</a></td>
					...
					<td>Human resource management</td>
												...
												<!--	<td><a href="allocatetrainercourse.php?trid=64" class="btn btn-primary">allocate</a></td> -->
													<td><a href="connection_files/manage/dealloctrainer.php?trid=64&delete=delete" class="btn btn-danger">Delete</a></td>
