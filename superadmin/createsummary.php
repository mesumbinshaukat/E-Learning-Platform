...
<body class="ltr main-body app sidebar-mini">
	...
	<div class="page">
		...
		<form action="connection_files/create/summary_create.php" method="POST" enctype="multipart/form-data">
			<!-- main-content -->
			<!-- main-content -->
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="">
									...
									<button type="submit" name="submit" class="btn btn-info mt-3 mb-0" data-bs-target="#schedule" data-bs-toggle="modal" style="text-align:right">add
										Summary</button>
								</div>
							</div>
						</div>
