			...
			<div class="main-container container-fluid">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="right-content">
						<span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Manage Employee </span>
					</div>
				...
				<form method="post">
					<div class="row row-sm">
						<div class="form-group col-md-3">
							...
							<select name="employee_username" class="form-control form-select" data-bs-placeholder="Select Filter">
								<option value="all" selected="selected">ALL</option>
								<option value="balats">TRCLG_8_balats</option>
								<option value="pavantriaright">TRCLG_13_pavantriaright</option>
								<option value="shyamk">TRCLG_14_shyamk</option>
								<option value="ltarun">TRCLG_15_ltarun</option>
								<option value="gpari">TRCLG_16_gpari</option>
								<option value="kmadhu">TRCLG_17_kmadhu</option>
								<option value="demoemployee">TRCLG_18_demoemployee</option>
								<option value="admin@gmail.com">TRCLG_19_admin@gmail.com</option>
						...
						<div class="form-group col-md-3">
							...
							<select name="name_of_designation" class="form-control form-select" data-bs-placeholder="Select Filter">
								<option value="all" selected="selected">ALL</option>
									...
									<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
										...
										<tbody>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=8" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=8" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=8&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=8&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=8&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=8&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td> 2 </td>
												<td>TREMP_13</td>
												<td>Ammigalla Pavan</td>
												<td>pavantriaright</td>
												<td>12345678</td>
												<td>6303847827</td>
												<td>manager</td>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=13" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=13" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=13&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=13&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=13&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=13&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=14" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=14" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=14&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=14&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=14&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=14&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=15" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=15" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=15&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=15&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=15&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=15&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=16" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=16" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=16&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=16&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=16&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=16&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=17" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=17" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=17&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=17&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=17&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=17&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=18" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=18" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=18&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=18&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=18&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=18&allocate=allocate">allocate</a>
											...
											<tr>
												...
												<td>
													<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">
														...
														<div class="dropdown-menu">
															<a href="viewemployee.php?id=19" class="dropdown-item">view</a>
															<a href="updateemployee.php?id=19" class="dropdown-item">update</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=19&delete=delete">delete</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=19&block=block">block</a>
															<a class="btn dropdown-item" href="connection_files/manage/employee_manage.php?id=19&unblock=unblock">unblock</a>
															<a class="btn dropdown-item" href="allocateemployee.php?id=19&allocate=allocate">allocate</a>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content modal-content-demo">
							...
							<div class="modal-body">
								...
								<p> Are you sure you want to delete a employee??</p>
							</div>
