...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Pending internship Registrations </span> 
						</div>
...
<br>	
											...
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
												<thead>
													<tr>
														...
														<th class="border-bottom-0">date of request</th>
                ...
                <tr>
                    <td>1</td>
                    <td>2023-08-07 13:55:28</td>
				    <td>T .sudheer reddy</td>
                    <td>TRSTU_4267</td>
                    <td>triaright</td>
                    <td>testing</td>
                    ...
                    <td>											
							...
							<div class="dropdown-menu"> 
							<a href="allocateinternship.php?id=44&accept=accept" class="dropdown-item">Accept</a>
							<a href="connection_files/manage/internship_registration.php?id=44&reject=reject" class="dropdown-item">Reject</a>
				            <a class="btn dropdown-item" href="connection_files/manage/internship_registration.php?id=44&delete=delete">Delete</a>
							</div><!-- dropdown-menu -->
						</div>
                    </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>											
							...
							<div class="dropdown-menu"> 
							<a href="allocateinternship.php?id=46&accept=accept" class="dropdown-item">Accept</a>
							<a href="connection_files/manage/internship_registration.php?id=46&reject=reject" class="dropdown-item">Reject</a>
				            <a class="btn dropdown-item" href="connection_files/manage/internship_registration.php?id=46&delete=delete">Delete</a>
							</div><!-- dropdown-menu -->
						</div>
                    </td>
                    </tr>
											...
											<!--			<td>Individual</td>-->
											<!--			<td>Reject</td>-->
											<!--			<td><a href="reallocatestudentcourse.php" class="btn btn-primary">Re-allocate</a></td>-->
											<!--			<td>	-->
											<!--			<div class="col-sm-6 col-md-15 mg-t-10 mg-sm-t-0">-->
											<!--<button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">-->
											<!--		<i class="fe fe-more-horizontal"></i>-->
											...
											<!--		<div class="dropdown-menu">-->
											<!--	        <a href="" data-bs-target="#accept" data-bs-toggle="modal" class="dropdown-item">Accept</a>-->
											<!--			<a href=""data-bs-target="#reject" data-bs-toggle="modal" class="dropdown-item">Reject</a>-->
