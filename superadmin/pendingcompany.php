...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Pending Company </span> 
						</div>
											...
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
												...
												<tbody>
                                                      ...
                                                      <td>1</td>
                                                          ...
                                                          <td>howrah</td>
														  <td>2233445566</td>
														  <td><a href="updatecompany.php?id=21&page=pending" class="btn btn-info">update</a></td>
														<td><a href="connection_files/manage/company_manage.php?id=21&accept=accept" class="btn btn-success">Accept</a></td>
														<td><a href="connection_files/manage/company_manage.php?id=21&reject=reject" class="btn btn-danger">Reject</a></td>
