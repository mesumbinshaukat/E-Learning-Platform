                                    ...
                                    <table id="file-datatable"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>howrah</td>
                                                <td>2233445566</td>
                                                <td><a href="updatecompany.php?id=21&page=pending"
                                                        class="btn btn-info">update</a></td>
                                                <td><a href="connection_files/manage/company_manage.php?id=21&accept=accept"
                                                        class="btn btn-success">Accept</a></td>
                                                <td><a href="connection_files/manage/company_manage.php?id=21&reject=reject"
