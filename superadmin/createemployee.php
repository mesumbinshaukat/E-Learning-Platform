...
<form action="connection_files/create/employee_create.php" method="POST" enctype="multipart/form-data">
			<!-- main-content -->
			<!-- main-content -->
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700"> Create Employee</span>
						</div>
									...
									<div class="">
										<div class="row row-xs formgroup-wrapper">
											<div class="col-md-6">
												...
												<label for="exampleInputName">Employee Name <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span> </label>
												<input type="text" class="form-control" id="exampleInputName" name="employee_name" placeholder="Enter Name" required>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone"> Company Phone Number <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="number" class="form-control" id="exampleInputCompanyPhone" maxlength="14" minlength="10" name="company_phone_number" placeholder="Enter Contact Number" required>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone"> Personal Phone Number <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="number" class="form-control" id="exampleInputPersonalPhone" maxlength="14" minlength="10" name="personal_phone_number" placeholder="Enter Personal Number" required>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPerEmail"> Personal Mail Id <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="email" class="form-control" id="exampleInputPerEmail" name="personal_mail_id" placeholder="Enter Mail Id" required>
											</div>
											</div>
											
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputProEmail"> Professional Mail Id <span style="color:#D3D3D3;font-size: 90%;">(Optional) </span> </label>
												<input type="email" class="form-control" id="exampleInputProEmail" name="professional_mail_id" placeholder="Enter Mail Id">
											</div>
											</div>
										    <div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control" id="dateMask" placeholder="YYYY/mm/dd" name="date_of_birth" type="date" required>
											</div>
											</div>
																						<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="exampleInputQualification" name="quallification" placeholder="Enter qualification" required>
											</div>
											</div>
											...
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputAadhar">Aadhar Card No <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="number" class="form-control" id="exampleInputAadhar" name="aadhar_card_number" placeholder="Enter Aadhar Number" required>
											</div>
											</div>
																						...
																						<div class="col-md-6">
											<div class="form-group">
										<label for="exampleInputAadhar">Name of Designation <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
										<select  class="form-control form-select" name="name_of_designation" data-bs-placeholder="Select Country">
											...
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputUserName">Date of joining  <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input class="form-control" id="dateMask"  name="date_of_joining" type="date" required>
											</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputUserName">Employee Username <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="text" class="form-control" id="exampleInputUserName" name="employee_username" placeholder="Enter Username" required>
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input type="password" class="form-control" id='password' name="password" minlength=8 maxlength=10 placeholder="Enter Password" required>
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input type="password" class="form-control" id='retypepassword' minlength=8 maxlength=10  placeholder="Re-Enter Password" required>
											</div>
											</div>
											...
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputcode"> Referal Code <span style="color:#D3D3D3;font-size: 90%;">(Optional) </span></label>
												<input type="text" class="form-control" id="exampleInputcode" name="referral_code" placeholder="Enter Referal Code" >
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputcode"> Employee documents <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="file" class="form-control" id="exampleInputcode" name="employee_documents" placeholder="" required>
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputcode"> Appointment letter <span style="color:#D3D3D3;font-size: 90%;">(Mandatory</span> <span style="color:red;font-size: 90%;">*</span><span style="color:#D3D3D3;font-size: 90%;">)</span></label>
												<input type="file" class="form-control" id="exampleInputcode" name="appointement_letter" placeholder="" required>
											</div>
											</div>
										<div class="col-md-12">
											<div class="form-group"> 
												<label for="exampleInputcode"> Additional information <span style="color:#D3D3D3;font-size: 90%;">(Optional)</span></label>
												<input type="text" class="form-control"  id="exampleInputcode" name="additional_information" placeholder="Add Additional info" required>
											</div>
											</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to create a employee??</p>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn ripple btn-success" name="create" type="submit">Create</button>
