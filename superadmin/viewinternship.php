                                ...
                                <div id="wizard3">
                                    ...
                                    <section>
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" readonly class="form-control" disabled
                                                placeholder="Course Name" value="<?php echo $fetch['company_name']; ?>">
                                        </div>
                                        <div class="control-group form-group">
                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" class="form-control" readonly disabled
                                                placeholder="Stream" value="<?php echo $fetch["industry"] ?>">
                                        </div>
                                        <div class="control-group form-group">
                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" class="form-control" readonly disabled
                                                placeholder="Eligibility" value="<?php echo $fetch["eligibility"] ?>">
                                        </div>
                                        <div class="control-group form-group">
                                            <label class="form-label">Location</label>
                                            <input type="" class="form-control" readonly disabled
                                                placeholder="Enter Location" value="<?php echo $fetch["location"] ?>">
                                        </div>
                                        <div class="control-group form-group">
                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" class="form-control" readonly disabled placeholder="Both"
                                                value="<?php echo $fetch["gender"] ?>">
                                        </div>
                                        <div class="control-group form-group">
                                            <label class="form-label">Number of Vacancies</label>
                                            <input type="number" class="form-control" readonly disabled
                                                placeholder="Vaccancies Count"
                                        ...
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" class="form-control" readonly disabled placeholder="Yes"
                                    ...
                                    <section>
                                        ...
                                        <div class="form-label">
                                            <input class="form-control" readonly disabled placeholder="Textarea"
                                                rows="5" value="<?php echo $fetch["full-description"] ?>"></input>
                                        </div>
                                        ...
                                        <div class="form-label">
                                            <input class="form-control" readonly disabled placeholder="Textarea"
                                                rows="5" value="<?php echo $fetch["pre-requirements"] ?>"></input>
                                        </div>

                                        <label class="form-label">additional information</label>
                                        <div class="form-label">
                                            <input class="form-control" readonly disabled placeholder="Textarea"
                                                rows="3" value="<?php echo $fetch["additional_info"] ?>">
                                        </div>
                                    ...
                                    <section>
                                        <div class="control-group form-group">
                                            ...
                                            <input type="text" class="form-control" readonly disabled placeholder="Paid"
                                                name="internship_type" value="<?php echo $fetch["internship_type"] ?>">
