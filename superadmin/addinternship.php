...
<div class="main-sidebar-header active">
			...
			</div><form action="connection_files/create/addinternship_create.php" method="POST" enctype="multipart/form-data">
			<!-- main-content -->
								...
								<div class="card-body">
									...
									<div id="wizard3">
										...
										<select class="form-control form-select select2" name="industry" data-bs-placeholder="Select Stream" required>
										 <option value="Information Technology">Information Technology</option>  <option value="Non IT">Non IT</option>  <option value="Finance">Finance</option>  <option value="Pharmaceuticals">Pharmaceuticals</option>  <option value="Management">Management</option>  <option value="event">event</option>  <option value="TESTING">TESTING</option>  <option value="sample dinesh">sample dinesh</option> 										</select>
											</div>
										<div class="control-group form-group">
									 ...
									 <label class="form-label">additional information</label>
										...
										<select  class="form-control form-select select2" name="internship_type" data-bs-placeholder="Internship Type" required>
											...
											<option value="Stipend">Stipend</option>
												...
												<input type="number" class="form-control"  name="enter_value_ifpaid" placeholder="0,000/-" required>
											</div>
												<div class="control-group form-group">
												<label class="form-label">Enter Value (if stifund)</label>
												<input type="number" class="form-control"  name="enter_value_ifstifund" placeholder="0,000/-" required>
											</div>
