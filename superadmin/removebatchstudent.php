					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="removebatchstudent.php@trainer_id=44.html" class="header-logo">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="removebatchstudent.php@trainer_id=44.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/superadmin/assets/img/faces/2.jpg" class=""></a>
