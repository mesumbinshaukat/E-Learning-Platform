								...
								<div class="card-body">
									...
									<div id="wizard3">
										...
										<select class="form-control form-select select2" required name="stream" data-bs-placeholder="select qulification" required>
										 ...
										 <option value="Information Technology">Information Technology</option>  <option value="Non IT">Non IT</option>  <option value="Finance">Finance</option>  <option value="Pharmaceuticals">Pharmaceuticals</option>  <option value="Management">Management</option> 
									</select>
											</div>
											<div class="control-group form-group mb-2">		
										...
										<select  class="form-control form-select select2"  name="provider_name"  data-bs-placeholder="Select stream" required>
											<option value="Triaright">Triaright (self)</option>
											 <option value="Vispobusol">Vispobusol</option>  <option value="Avshrhyd">Avshrhyd</option>  <option value="earn@123">earn@123</option>  <option value="andhracompany">andhracompany</option>  <option value="testing@123">testing@123</option>  <option value="mycompany@7">mycompany@7</option>  <option value="sajnjkdbnfka">sajnjkdbnfka</option>  <option value="Sunitha@123">Sunitha@123</option>  <option value="Bharat Biotech">Bharat Biotech</option>  <option value="demo company">demo company</option>  <option value="D.Reddy prasad">D.Reddy prasad</option>  <option value="VASAPALLI SWATHI">VASAPALLI SWATHI</option>  <option value="8179651078">8179651078</option>  <option value="R.R.Pushpa.choppala">R.R.Pushpa.choppala</option>  <option value="9346378189">9346378189</option>  <option value="8977213833">8977213833</option>  <option value="Long term ">Long term </option>  <option value="2000000000">2000000000</option>  <option value="onlinefood@2001">onlinefood@2001</option>  <option value="1212@gmail.com">1212@gmail.com</option> 						 					
										</select>
											</div>
										...
										<select class="form-control form-select select2" name="training_type"  data-bs-placeholder="Select training type" required>
											...
											<option value=" VirtualRecordedSessions"> Virtual Recorded Sessions</option>
										</select>
											</div>
											<div class="control-group form-group">
