                                        ...
                                        <section>
                                            ...
                                            <div class="control-group form-group mb-2">
                                                ...
                                                <select class="form-control form-select select2" name="provider_name"
                                                    ...
                                                    <option value="Vispobusol">Vispobusol</option>
                                                    <option value="Avshrhyd">Avshrhyd</option>
                                                    <option value="earn@123">earn@123</option>
                                                    <option value="andhracompany">andhracompany</option>
                                                    <option value="testing@123">testing@123</option>
                                                    <option value="mycompany@7">mycompany@7</option>
                                                    <option value="sajnjkdbnfka">sajnjkdbnfka</option>
                                                    <option value="Sunitha@123">Sunitha@123</option>
                                                    <option value="Bharat Biotech">Bharat Biotech</option>
                                                    <option value="demo company">demo company</option>
                                                    <option value="D.Reddy prasad">D.Reddy prasad</option>
                                                    <option value="VASAPALLI SWATHI">VASAPALLI SWATHI</option>
                                                    <option value="8179651078">8179651078</option>
                                                    <option value="R.R.Pushpa.choppala">R.R.Pushpa.choppala</option>
                                                    <option value="9346378189">9346378189</option>
                                                    <option value="8977213833">8977213833</option>
                                                    <option value="Long term ">Long term </option>
                                                    <option value="2000000000">2000000000</option>
                                                    <option value="onlinefood@2001">onlinefood@2001</option>
                                                    <option value="1212@gmail.com">1212@gmail.com</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="control-group form-group">
                                                <label class="form-label">Offline address ( if offline ) <span
                                                        ...
                                                        style="color:red;font-size: 90%;">*</span><span
                                                        style="color:#D3D3D3;font-size: 90%;">)</span></label>
                                                <input type="" class="form-control required" name="offline_address"
