					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="updatefinalbatchcreate.php@id=47.html" class="header-logo">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="updatefinalbatchcreate.php@id=47.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/superadmin/assets/img/faces/2.jpg" class=""></a>
...
<div class="main-sidebar-header active">
			...
			</div><form action="https://triaright.com/superadmin/connection_files/update/studentbatch_update.php" method="POST" enctype="multipart/form-data"> 
			<!-- main-content -->
			<!-- main-content -->
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="">
										<div class="row row-xs formgroup-wrapper">
											<div class="col-md-6">
												...
												<input type="text" class="form-control" name="id" id="exampleInputName" value="47 " hidden>
												
												<input type="text" class="form-control" id="exampleInputName" name="batch_name" value="Web Technologies Batch 3 2M">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Class Duration</label>
												<input type="text" class="form-control" id="exampleInputPersonalPhone" name="class_duration" value="2">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone"> Course ID</label>
												<input type="text" class="form-control" id="exampleInputCompanyPhone" name="course_id" readonly value="33">  
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Course name</label>
												<input type="text" class="form-control" id="exampleInputPersonalPhone" name="course_name" readonly value="Web Technologies">
											</div>
											</div>
												<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone"> Trainer ID</label>
												<input type="text" class="form-control" id="exampleInputCompanyPhone" name="trainer_id" readonly value="44">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Trainer name</label>
												<input type="text" class="form-control" id="exampleInputPersonalPhone" name="trainer_name" readonly value="tirdhala ashok">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Batch starting date</label>
												<input type="date" class="form-control" id="exampleInputPersonalPhone" name="batch_starting_date" value="2023-09-27">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Batch ending date</label>
												<input type="date" class="form-control" id="exampleInputPersonalPhone"  name="batch_ending_date" value="2023-11-27">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
										<label for="exampleInputAadhar">Session slot</label>
										<select name="session_slot" class="form-control form-select select2" data-bs-placeholder="Select Country">
										...
										<option value="Evening-1" >Evening-1</option>
										<option value="Evening-2"  selected="selected">Evening-2</option>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control"  id="exampleInputcode" name="additional_info" value="Na">
											</div>
											</div>
									...
									&nbsp &nbsp	<button type="submit" class="btn btn-danger mt-3 mb-0">Cancel</button>
										</div>
									</div>
								</div>
							</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to update a batch??</p>
                                </div>
        ...
        <!-- BACK-TO-TOP -->
		<a href="updatefinalbatchcreate.php@id=47.html#top" id="back-to-top"><i class="las la-arrow-up"></i></a>
