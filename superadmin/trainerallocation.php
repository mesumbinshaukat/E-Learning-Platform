...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Allocate Trainers </span> 
						</div>
...
<br>	
					...
					<td></td>
                    <td></td>
					<td><a href="allocatetrainercourse.php?trid=4" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>2</td>
					...
					<td>Graduate</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=5" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>3</td>
					...
					<td>NA</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=18" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>4</td>
					...
					<td>MCA</td>
                    <td>Fresher</td>
					<td><a href="allocatetrainercourse.php?trid=19" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>5</td>
					...
					<td></td>
                    <td></td>
					<td><a href="allocatetrainercourse.php?trid=24" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>6</td>
					...
					<td>Btech</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=27" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>7</td>
					...
					<td>BTECH</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=28" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>8</td>
                    ...
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=30" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>9</td>
                    ...
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=31" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>10</td>
					...
					<td>Bsc</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=32" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>11</td>
                    ...
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=33" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>12</td>
					...
					<td>Btech</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=35" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>13</td>
                    ...
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=36" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>14</td>
					...
					<td>Btech</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=38" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>15</td>
					...
					<td>Btech</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=39" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>16</td>
					...
					<td>MBA</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=40" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>17</td>
					...
					<td>B.Tech</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=41" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>18</td>
                    ...
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=44" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>19</td>
					...
					<td>BSC</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=45" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>20</td>
					...
					<td></td>
                    <td></td>
					<td><a href="allocatetrainercourse.php?trid=46" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>21</td>
					...
					<td>pursuing PGDM</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=47" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>22</td>
					...
					<td>cse</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=49" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>23</td>
					...
					<td>B-tech</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=50" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>24</td>
					...
					<td>B.TECH</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=51" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>25</td>
					...
					<td>B.tech</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=52" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>26</td>
					...
					<td>MCA</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=56" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>27</td>
					...
					<td>B.E</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=57" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>28</td>
					...
					<td>MBA</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=58" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>29</td>
					...
					<td>MBA</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=59" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>30</td>
					...
					<td>Btech</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=61" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>31</td>
					...
					<td>degree</td>
                    <td>no</td>
					<td><a href="allocatetrainercourse.php?trid=62" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>32</td>
					...
					<td>MCA</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=63" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>33</td>
					...
					<td>MBA</td>
                    <td>yes</td>
					<td><a href="allocatetrainercourse.php?trid=64" class="btn btn-info">allocate</a></td>
													</tr>
													                <tr>
                    <td>34</td>
					...
					<td></td>
                    <td></td>
					<td><a href="allocatetrainercourse.php?trid=65" class="btn btn-info">allocate</a></td>
													</tr>
