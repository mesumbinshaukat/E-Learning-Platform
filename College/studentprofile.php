...
<head>
       ...
       <!-- FAVICON -->
<link rel="icon" href="https://triaright.com/College/assets/img/icon.png" type="image/x-icon"/>

		<!-- ICONS CSS -->
		<link href="https://triaright.com/College/assets/plugins/icons/icons.css" rel="stylesheet">

		<!-- BOOTSTRAP CSS -->
		<link href="https://triaright.com/College/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

		<!-- RIGHT-SIDEMENU CSS -->
		<link href="https://triaright.com/College/assets/plugins/sidebar/sidebar.css" rel="stylesheet">

		<!-- P-SCROLL BAR CSS -->
		<link href="https://triaright.com/College/assets/plugins/perfect-scrollbar/p-scrollbar.css" rel="stylesheet" />

        
		<!-- Data table css -->
		<link href="https://triaright.com/College/assets/plugins/datatable/css/dataTables.bootstrap5.css" rel="stylesheet" />
		<link href="https://triaright.com/College/assets/plugins/datatable/css/buttons.bootstrap5.min.css"  rel="stylesheet">
		<link href="https://triaright.com/College/assets/plugins/datatable/responsive.bootstrap5.css" rel="stylesheet" />

		<!-- INTERNAL Select2 css -->
		<link href="https://triaright.com/College/assets/plugins/select2/css/select2.min.css" rel="stylesheet" />

            
		<!-- STYLES CSS -->
		<link href="https://triaright.com/College/assets/css/style.css" rel="stylesheet">
		<link href="https://triaright.com/College/assets/css/style-dark.css" rel="stylesheet">
		<link href="https://triaright.com/College/assets/css/style-transparent.css" rel="stylesheet">


		<!-- SKIN-MODES CSS -->
		<link href="https://triaright.com/College/assets/css/skin-modes.css" rel="stylesheet" />

		<!-- ANIMATION CSS -->
		<link href="https://triaright.com/College/assets/css/animate.css" rel="stylesheet">

	    <!-- SWITCHER CSS -->
		<link href="https://triaright.com/College/assets/switcher/css/switcher.css" rel="stylesheet"/>
		<link href="https://triaright.com/College/assets/switcher/demo.css" rel="stylesheet"/>
 ...
 <!--                           </div>-->
	...
	<!--	</div>-->
		...
		<div id="global-loader">
			<img src="https://triaright.com/College/assets/img/preloader.svg" class="loader-img" alt="Loader">
		</div>
		<!-- /Loader -->
					...
					<div class=" main-container container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="studentprofile.php@id=5020.html" class="header-logo">
									<img src="https://triaright.com/College/assets/img/logowhite.png" class="mobile-logo logo-1" alt="logo">
									<img src="https://triaright.com/College/assets/img/logoblack.png" class="mobile-logo dark-logo-1" alt="logo">
								</a>
							</div>
							...
							<div class="logo-horizontal">
								<a href="https://triaright.com/College/index.html" class="header-logo">
									<img src="https://triaright.com/College/assets/img/logowhite.png" class="mobile-logo logo-1" alt="logo">
									<img src="https://triaright.com/College/assets/img/logoblack.png" class="mobile-logo dark-logo-1" alt="logo">
								</a>
							</div>
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="studentprofile.php@id=5020.html#" data-bs-toggle="dropdown"><img alt="" src="https://triaright.com/images/college/profile/" class=""></a>
											<div class="dropdown-menu">
												<div class="menu-header-content p-3 border-bottom">
													<div class="d-flex wd-100p">
														<div class="main-img-user"><img alt="" src="https://triaright.com/images/college/profile/" class=""></div>
														<div class="ms-3 my-auto">
												<h6 class="tx-15 font-weight-semibold mb-0"></h6><span class="dropdown-title-text subtext op-6  tx-12">College</span>
														</div>
													</div>
												</div>
							
												
												<a class="dropdown-item" href="https://triaright.com/College/changepassword.php"><i class="far fa-sun"></i>Change Password</a>
 ...
 <div class="sticky">
					<aside class="app-sidebar">
						<div class="main-sidebar-header active">
							<a class="header-logo active" href="https://triaright.com/College/index.php">
								<img src="https://triaright.com/College/assets/img/logowhite.png" class="main-logo  desktop-logo" alt="logo">
								<img src="https://triaright.com/College/assets/img/logoblack.png" class="main-logo  desktop-dark" alt="logo">
								<img src="https://triaright.com/College/assets/img/icon.png" class="main-logo  mobile-logo" alt="logo">
								<img src="https://triaright.com/College/assets/img/icon.png" class="main-logo  mobile-dark" alt="logo">
							</a>
						</div>
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/dashboard.php"><i class="si si-event" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">Dashboard</span></a>
									
									</li>
								
					
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/mystudents.php"><i class="fe fe-users" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">My Students</span></a>
								</li>
																<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/College/registercourse.php">Register</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/pendingstudents.php">Pending</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/managecourses.php">Manage</a></li>
									</ul>
								</li>
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/internships.php"><i class="fe fe-feather" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">Internships</span></a>
								</li>
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/placements.php"><i class="fe fe-file-text" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">Placements</span></a>
								</li>
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/College/pendingpayments.php">Pending</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/transactions.php">Transactions</a></li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/College/createcollegementor.php">Create</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/managementor.php">Manage</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/allocatementor.php">Allocate</a></li>
							...
							<!--	<li class="slide">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/College/compose.php">Compose</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/inbox.php">Inbox</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/outbox.php">Outbox</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/allmessages.php">All Details</a></li>
									</ul>
								</li>
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="https://triaright.com/College/documentation.php">Documentations</a></li>
										<li><a class="slide-item" href="https://triaright.com/College/certifications.php">Certifications</a></li>
									</ul>
								</li>
									...
									<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/profile.php"><i class="fe fe-user" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">Profile</span></a>
								
									<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide" href="https://triaright.com/College/changepassword.php"><i class="fe fe-lock" width="24" height="24" viewBox="0 0 24 24"></i>&nbsp &nbsp  <span class="side-menu__label">Change Password</span></a>
							...
							<div class="card-body d-md-flex">
								<div class="">
									<span class="profile-image pos-relative">
										<img class="br-5" alt="" src="https://triaright.com/College/assets/img/r1.jpg">
										
									</span>
								</div>
								<div class="my-md-auto mt-4 prof-details">
									<h4 class="font-weight-semibold ms-md-4 ms-0 mb-3 pb-0">Username</h4>
									...
									<p class="text-muted ms-md-4 ms-0 mb-3"><span><i
											...
											class="font-weight-semibold me-2">Address:</span><span> MY Company,Visakhapatnam- 530040</span>
									</p>
									
								&nbsp

										
	<a target="_blank" href="https://triaright.com/images/students/cv/651be9224344d" >	<button type="submit" class="btn btn-primary mt-3 mb-0" name="upload_cv" style="text-align:right">Download</button></a>
											...
											<!--	<div class="mb-4 main-content-label">Name</div> -->
													...
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="Student Name" value="Neha banu" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																	placeholder="gender" value="male" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="date" class="form-control" id="dateMask"
																	placeholder="date_of_birth" value="0000-00-00" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="Number" class="form-control"
																placeholder="phone_number" value="9502509747" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																placeholder="alternative_phone_number" value="9502509747" disabled>
														</div>
													</div>
												</div>
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control" 	placeholder="mail_id" value="banuneha642@gmail.com" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
																<input type="text" class="form-control" 	placeholder="address" value="Nizam vali colony kadiri" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="district" value="Sri sathya sai" disabled>
														</div>
													</div>
												</div>
																								<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																	placeholder="state" value="Andhra Pradesh " disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																	placeholder="pincode" value="595591" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="qualification" value="+12" disabled>
														</div>
													</div> 
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="semester" value="5thsem" disabled>
														</div>
													</div>
												</div>   
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="stream" value="Kadiri" disabled>
														</div>
													</div>
												</div>
											<!--	<div class="mb-4 main-content-label">Social Info</div> -->
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="account_type" value="college" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																...
																placeholder="institution_name" value="" disabled>
														</div>
													</div>
												</div>
											</form>
			...
			<div class="main-footer">
				<div class="container-fluid pd-t-0-f ht-100p">
					 Copyright © 2023 <a href="https://triaright.com/College/www.triaright.com" class="text-primary">triaright</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="http://www.mycompany.co.in"> my company</a> . All rights reserved
				</div>
			</div>
		...
		<!-- JQUERY JS -->
		<script src="https://triaright.com/College/assets/plugins/jquery/jquery.min.js"></script>

		<!-- BOOTSTRAP JS -->
		<script src="https://triaright.com/College/assets/plugins/bootstrap/js/popper.min.js"></script>
		<script src="https://triaright.com/College/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

		<!-- IONICONS JS -->
		<script src="https://triaright.com/College/assets/plugins/ionicons/ionicons.js"></script>

		<!-- MOMENT JS -->
		<script src="https://triaright.com/College/assets/plugins/moment/moment.js"></script>

		<!-- P-SCROLL JS -->
		<script src="https://triaright.com/College/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
		<script src="https://triaright.com/College/assets/plugins/perfect-scrollbar/p-scroll.js"></script>

		<!-- SIDEBAR JS -->
		<script src="https://triaright.com/College/assets/plugins/side-menu/sidemenu.js"></script>

		<!-- STICKY JS -->
		<script src="https://triaright.com/College/assets/js/sticky.js"></script>

		<!-- Chart-circle js -->
		<script src="https://triaright.com/College/assets/plugins/circle-progress/circle-progress.min.js"></script>

		<!-- RIGHT-SIDEBAR JS -->
		<script src="https://triaright.com/College/assets/plugins/sidebar/sidebar.js"></script>
		<script src="https://triaright.com/College/assets/plugins/sidebar/sidebar-custom.js"></script>

        
        <!-- Internal Select2 js-->
        <script src="https://triaright.com/College/assets/plugins/select2/js/select2.min.js"></script>
        <script src="https://triaright.com/College/assets/js/select2.js"></script>


        <script src="https://triaright.com/College/assets/js/gallery.js"></script>

    
		<!-- EVA-ICONS JS -->
		<script src="https://triaright.com/College/assets/plugins/eva-icons/eva-icons.min.js"></script>

		<!-- THEME-COLOR JS -->
		<script src="https://triaright.com/College/assets/js/themecolor.js"></script>

		<!-- CUSTOM JS -->
		<script src="https://triaright.com/College/assets/js/custom.js"></script>

		<!-- exported JS -->
		<script src="https://triaright.com/College/assets/js/exported.js"></script>

		<!-- SWITCHER JS -->
		<script src="https://triaright.com/College/assets/switcher/js/switcher.js"></script>
