									...
									<div class="row">
										...
										<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
											<div class="text-justified align-items-center">
												...
												<p class="text-dark tx-15 mb-2 lh-3">Thankyou for choosing us, We are delighted that you have joined us and we look forward to providing candidates with a wealth of resources and information that will help candidates succeed in their academic journey.</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                            ...
                                            <img class="rounded-pill" src="assets/img/r1.jpg" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
 <span style="color:#ff6700"> Review person 1 </span>
                                        </div>
                                        <div class="tx-14 text-center text-muted mb-3">
                                           Designation
                                        </div>
										<div class="text-center tx-14 mb-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam similique provident !</div>
