   <aside class="app-sidebar">
       <div class="main-sidebar-header active">
           <a class="header-logo active" href="index.php">
               <img src="assets/img/tabnine-logo.png" class="main-logo  desktop-logo" alt="logo">
               <img src="assets/img/tabnine-logo.png" class="main-logo  desktop-dark" alt="logo">
               <img src="assets/img/WordPress_blue_logo.svg.png" class="main-logo  mobile-logo" alt="logo">
               <img src="assets/img/WordPress_blue_logo.svg.png" class="main-logo  mobile-dark" alt="logo">
           </a>
       </div>
