...
<div class="breadcrumb-header justify-content-between">
						<div class="right-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700">Pending Payments </span> 
						</div>
											...
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
												<thead>
													<tr>
														...
														<th class="border-bottom-0">No of Student ID</th>
														<th class="border-bottom-0">Course Name</th>
														<th class="border-bottom-0">Particular course fee</th>
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=6"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=10"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=34"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=17"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=33"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=32"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
									           ...
									           <td>-</td>
														...
														<td>
																		 <button class="btn btn-primary mb-3 shadow"><a href="makereferalcodestatus.php?crid=8"><span style="color:#ffffff;">Make payment</span></a></button> &nbsp &nbsp 
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to accept a company?</p>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to reject a company?</p>
                                </div>
                                <div class="modal-footer">
