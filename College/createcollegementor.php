...
<link rel="icon" href="assets/img/icon.png" type="image/x-icon"/>
 ...
 <div class="sticky">
			...
			<!-- main-content -->
			<!-- main-content -->
			<form action="../superadmin/connection_files/create/mentor_create.php" method="POST"> 
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1" style="color:#ff6700"> Create College Mentor</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Credentials</a></li>
								<li class="breadcrumb-item active" aria-current="page">College Mentor</li>
								...
								<div class="">
										<div class="row row-xs formgroup-wrapper">
											<div class="col-md-6">
												...
												<input type="text" class="form-control" id="exampleInputName" name="college_names" placeholder="Enter Name" value='' disabled>
												<input type="text" hidden class="form-control" id="exampleInputName" name="college_name" placeholder="Enter Name" value='' >
												<input type="text" hidden class="form-control" id="exampleInputName" name="type" value=college>

											</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputName">Name of Mentor</label>
												<input type="text" class="form-control" id="exampleInputName" name="name_of_mentor" placeholder="Enter Name">
											</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputUserName">Designation</label>
												<input type="text" class="form-control" id="exampleInputUserName" name="designation" placeholder="Enter Designation">
											</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputUserName">Department</label>
												<input type="text" class="form-control" id="exampleInputUserName" name="department" placeholder="Enter Department">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Phone Number</label>
												<input type="number" class="form-control" id="exampleInputPersonalPhone" name="phone_number" placeholder="Enter Contact Number">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputCompanyPhone">Alternative Phone Number</label>
												<input type="number" class="form-control" id="exampleInputCompanyPhone" name="alternative_phone_number" placeholder="Enter ALternative Phone Number">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Personal Mail Id</label>
												<input type="text" class="form-control" id="exampleInputPersonalPhone" name="personal_mailid" placeholder="Enter Mail Id">
											</div>
											</div>
											<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputPersonalPhone">Professional Mail Id</label>
												<input type="text" class="form-control" id="exampleInputPersonalPhone" name="professional_mailid" placeholder="Enter Represntative Number">
											</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
												<label for="exampleInputUserName">Mentor Username</label>
												<input type="text" class="form-control" id="exampleInputUserName" name="mentor_username" placeholder="Enter Username">
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input type="password" class="form-control" id="password" name="password" minlength=8 maxlength=10 placeholder="Enter Password">
											</div>
											</div>
											...
											<div class="col-md-6">
												...
												<input type="password" class="form-control" id="retypepassword"  minlength=8 maxlength=10 name="re_enter_password" placeholder="Re-Enter Password">
											</div>
											</div>
											
									
						
										<button type="submit" name="create" value="create" class="btn btn-primary mt-3 mb-0" onclick="return check()" style="text-align:right">Generate</button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p> Are you sure you want to Create a college mentor?</p>
                                </div>
