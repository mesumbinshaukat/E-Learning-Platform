	...
	<form method="post">
					<div class="row row-sm">
								...
								<b>	 <label>Department</label> </b>
										<select name="department" class="form-control form-select" data-bs-placeholder="Select Filter">
											...
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
												...
												<button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
														...
														<div class="dropdown-menu">
															...
															<a class="btn dropdown-item" href="../superadmin/connection_files/manage/mentor_manage.php?id=6&delete=delete&page=college">delete</a>
															<a class="btn dropdown-item" href="../superadmin/connection_files/manage/mentor_manage.php?id=6&block=block&page=college">block</a>
															<a class="btn dropdown-item" href="../superadmin/connection_files/manage/mentor_manage.php?id=6&unblock=unblock&page=college">unblock</a>
	
															
															<!-- <a href="allocatementor.html" class="dropdown-item">Allocate</a> -->
														</div><!-- dropdown-menu -->
													</div></td>
