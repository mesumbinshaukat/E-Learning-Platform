						...
						<div class="custom-card main-content-body-profile">
							<div class="tab-content">
								<div class="main-content-body tab-pane  active" id="about">
										...
										<div class="card-body border-0">
											...
											<!--	<div class="mb-4 main-content-label">Name</div> -->
												...
												<div class="form-group ">
													<div class="row row-sm">
														<div class="col-md-3">
															<label class="form-label">College Representative Contact No</label>
														</div>
														<div class="col-md-9">
															<input type="Number" readonly class="form-control"
																placeholder="college_representative_contact_no" value="" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="college_representative_mail_id" value="" disabled> 
														</div>
													</div>
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
																	placeholder="district" value="" disabled>
														</div>
													</div>
												</div>
																								<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="text" class="form-control"
															placeholder="state" value="" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
													<div class="row row-sm">
														...
														<div class="col-md-9">
															<input type="number" class="form-control"
																placeholder="pin_code" value="" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
											...
											<!--	<div class="mb-4 main-content-label">Social Info</div> -->
												...
												<div class="form-group ">
													...
													<div class="col-md-9">
															<input type="text" class="form-control"
																placeholder="password" value="Mycompany@123" disabled>
														</div>
													</div>
												</div>
												<div class="form-group ">
									...
									<button class="btn ripple btn-primary" type="button"><a href="updatecollegeprofile.php?id=&page=profile">update profile</a></button>			
											</form>
										</div>
									</div>
								</div>
