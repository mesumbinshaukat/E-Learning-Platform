...
<html lang="en">
	...
	<head>
		...
		<!-- Title -->
		<title> TraiRight: The New Era of Learning</title>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8a8f16cf53download.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									<h4 class="card-title mb-3"><span style="color:#ff6700; Font-size:18px">Information Technology</span></h4>
										<div class="user-wideget-footer">
									<div class="row">
										<div class="col-sm-4 border-end">
											<div class="description-block">
												<h5 class="description-header"></h5>
												<p class="card-text"><span style="color:#999999; Font-size:11px">Companies</span></p>
											</div>
										</div>
										<div class="col-sm-4 border-end">
											<div class="description-block">
												...
												<p class="card-text"><span style="color:#999999; Font-size:11px">Postings</span></p>
											</div>
										</div>
										...
										<div class="col-sm-4">
											<div class="description-block">
												<h5 class="description-header"></h5>
												<p class="card-text"><span style="color:#999999; Font-size:11px">Vacancy</span></p>
											</div>
										</div>
									</div>
								</div>
							
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=Information Technology">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8ab3f983e9Capture.PNG"  alt="welcome" width="300" height="300">
								<div class="card-body">
									<h4 class="card-title mb-3"><span style="color:#ff6700; Font-size:18px">Non IT</span></h4>
										<div class="user-wideget-footer">
									<div class="row">
										<div class="col-sm-4 border-end">
											<div class="description-block">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=Non IT">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8aa26732f52018-07-09-WhatExpectEarnFinanceDegree-ThinkstockPhotos-494940062.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=Finance">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8aa6bdd3b1images.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=Pharmaceuticals">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/63f8aabcd4e4bwealth_inicial.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=Management">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/64187a6db77d8c16.jpg"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=event">Check now</a>
								</div>
							 </div>
						</div>
...
<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="../images/streams/image/641e798a9bfffCapture.PNG"  alt="welcome" width="300" height="300">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="viewplacements2.php?course=TESTING">Check now</a>
								</div>
							 </div>
						</div>
