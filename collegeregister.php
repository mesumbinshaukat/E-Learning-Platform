...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_prepare($conn, "INSERT INTO `college` (`name`, `username`, `password`, `email`, `contact_number`, `hashed_password`) 
              VALUES (?,?,?,?,?,?)");
    $query->bind_param("ssssss", $college_name, $college_username, $password, $college_mail_id, $phone_number, $encryptedPassword);
